...
**9378 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 2278 | Plugins that enhance the DSH web/terminal user interface. |

| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 183 | Skins, themes, and appearance customization for DSH. |

| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1045 | Session management, message editing, sharing, and conversation tools. |

| 🧠 [Memory](categories/memory.md) | 191 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 2200 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |

| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 2389 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |

| 🔔 [Notifications & Integrations](categories/notifications-integrations.md) | 14 | WeChat, Telegram, IM bridges, desktop notifications, and external integrations. |
...
| ⚠️ [Weakly Related](categories/weakly-related.md) | 490 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
▶️ [View all 2278 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 183 plugins →](categories/themes-appearance.md)
...
▶️ [View all 1045 plugins →](categories/sessions-messages.md)
...
▶️ [View all 191 plugins →](categories/memory.md)
...
▶️ [View all 2200 plugins →](categories/tools-capabilities.md)
...
▶️ [View all 2389 plugins →](categories/workflow-automation.md)
...
▶️ [View all 14 plugins →](categories/notifications-integrations.md)
...
490 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 490 repos →](categories/weakly-related.md)
