...
**7411 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 1756 | Plugins that enhance the DSH web/terminal user interface. |

| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 149 | Skins, themes, and appearance customization for DSH. |

| 💬 [Sessions & Messages](categories/sessions-messages.md) | 814 | Session management, message editing, sharing, and conversation tools. |

| 🧠 [Memory](categories/memory.md) | 160 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 1773 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |

| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 1917 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| 🔌 [Models & Providers](categories/models-providers.md) | 28 | Multi-model support, OAuth login, LLM fallback strategies, and provider bridges. |
...
| 📋 [Awesome Lists & Collections](categories/awesome-lists.md) | 164 | Curated collections and awesome lists of DSH plugins. |

| ⚠️ [Weakly Related](categories/weakly-related.md) | 374 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
▶️ [View all 1756 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 149 plugins →](categories/themes-appearance.md)
...
▶️ [View all 814 plugins →](categories/sessions-messages.md)
...
▶️ [View all 1773 plugins →](categories/tools-capabilities.md)
...
▶️ [View all 1917 plugins →](categories/workflow-automation.md)
...
▶️ [View all 28 plugins →](categories/models-providers.md)
...
▶️ [View all 164 plugins →](categories/awesome-lists.md)


### ⚠️ Weakly Related


374 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 374 repos →](categories/weakly-related.md)
