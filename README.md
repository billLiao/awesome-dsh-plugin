...
**3974 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 1090 | Plugins that enhance the DSH web/terminal user interface. |

| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 94 | Skins, themes, and appearance customization for DSH. |

| 💬 [Sessions & Messages](categories/sessions-messages.md) | 515 | Session management, message editing, sharing, and conversation tools. |

| 🧠 [Memory](categories/memory.md) | 98 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 976 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |

| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 626 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| 🔌 [Models & Providers](categories/models-providers.md) | 15 | Multi-model support, OAuth login, LLM fallback strategies, and provider bridges. |
...
| 📋 [Awesome Lists & Collections](categories/awesome-lists.md) | 123 | Curated collections and awesome lists of DSH plugins. |

| ⚠️ [Weakly Related](categories/weakly-related.md) | 258 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
▶️ [View all 1090 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 94 plugins →](categories/themes-appearance.md)
...
▶️ [View all 515 plugins →](categories/sessions-messages.md)
...
▶️ [View all 98 plugins →](categories/memory.md)
...
▶️ [View all 976 plugins →](categories/tools-capabilities.md)
...
▶️ [View all 626 plugins →](categories/workflow-automation.md)
...
▶️ [View all 15 plugins →](categories/models-providers.md)
...
▶️ [View all 123 plugins →](categories/awesome-lists.md)


### ⚠️ Weakly Related


258 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 258 repos →](categories/weakly-related.md)
