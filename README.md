...
**14884 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
|----------|-------|-------------|
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 3824 | Plugins that enhance the DSH web/terminal user interface. |
| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 288 | Skins, themes, and appearance customization for DSH. |
| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1810 | Session management, message editing, sharing, and conversation tools. |
| 🧠 [Memory](categories/memory.md) | 327 | Persistent memory, knowledge bases, and context retention plugins. |
| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 3476 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |
| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 3169 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| ⚠️ [Weakly Related](categories/weakly-related.md) | 1020 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
- [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) ⭐35711 — DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.
- [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) ⭐8015 — DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
...
▶️ [View all 3824 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 1810 plugins →](categories/sessions-messages.md)


### 🧠 Memory

- [text2future/flowix](https://github.com/text2future/flowix) ⭐434 — Notes for you, Memory for your agents. / 内置 Deepseek harness Agent / 适用 办公 & 写作 & Coding
...
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) ⭐28989 — 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) ⭐9238 — DSHDesktop：DeepSeek Harness Desktop / DeepSeek Harness 桌面版
- [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) ⭐6710 — Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi-engine workspace for Codex Harness, DeepSeek Harness, and OpenCode, with unified plugins and Skills, multi-agent projects and tasks, and editable code, documents, presentations, design, and video.

▶️ [View all 3476 plugins →](categories/tools-capabilities.md)
...
- [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) ⭐4574 — The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH 可视化插件市场

▶️ [View all 3169 plugins →](categories/workflow-automation.md)
...
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐16898 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
...
1020 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 1020 repos →](categories/weakly-related.md)
