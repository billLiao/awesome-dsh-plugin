...
**9809 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 2407 | Plugins that enhance the DSH web/terminal user interface. |

| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 188 | Skins, themes, and appearance customization for DSH. |

| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1116 | Session management, message editing, sharing, and conversation tools. |

| 🧠 [Memory](categories/memory.md) | 205 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 2288 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |

| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 2451 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| 🔌 [Models & Providers](categories/models-providers.md) | 52 | Multi-model support, OAuth login, LLM fallback strategies, and provider bridges. |
...
| 📋 [Awesome Lists & Collections](categories/awesome-lists.md) | 199 | Curated collections and awesome lists of DSH plugins. |

| ⚠️ [Weakly Related](categories/weakly-related.md) | 516 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
- [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) ⭐35174 — DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running.
...
- [zhu1090093659/dsh-web-ui](https://github.com/zhu1090093659/dsh-web) ⭐6115 — DeepSeek Harness（DSH）Web 插件聚合生态包 · 一切皆插件，创意工坊分发

▶️ [View all 2407 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 188 plugins →](categories/themes-appearance.md)


### 💬 Sessions & Messages

- [MemTensor/MemOS](https://github.com/MemTensor/MemOS) ⭐10994 — Self-evolving memory OS for LLM & AI Agents: ultra-persistent memory, hybrid-retrieval, and cross-task skill reuse, with 35.24% token savings and DeepSeek Harness support.
...
▶️ [View all 1116 plugins →](categories/sessions-messages.md)
...
▶️ [View all 205 plugins →](categories/memory.md)


### 🛠️ Tools & Capabilities

- [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/dsh-desktop) ⭐20427 — 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) ⭐4869 — Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi-engine workspace for Codex Harness, DeepSeek Harness, and OpenCode, with unified plugins and Skills, multi-agent projects and tasks, and editable code, documents, presentations, design, and video.
- [xiaobright/dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard) ⭐3763 — Two-phase DeepSeek Harness preset: Minimal-aligned bootstrap, then full Standard tools (Project2 98/99)

▶️ [View all 2288 plugins →](categories/tools-capabilities.md)
...
- [whiteguo233/OpenBiliClaw](https://github.com/whiteguo233/OpenBiliClaw) ⭐3043 — 本地私有、开源的自进化跨平台 AI 内容发现 Agent：先理解你，再主动从 B站、小红书、抖音、YouTube、X、知乎、Reddit、微博等平台与开放 Web 寻找内容。（支持 deepseek harness 插件） | Local-first open-source cross-platform AI content discovery agent: understands you, then proactively finds content across Bilibili, Xiaohongshu, Douyin, YouTube, X, Zhihu, Reddit, Weibo and the open web.（support deepseek harness plugin）

▶️ [View all 2451 plugins →](categories/workflow-automation.md)
...
▶️ [View all 52 plugins →](categories/models-providers.md)
...
- [Gin-7/dsh-pet-remielle](https://github.com/Gin-7/dsh-pet-remielle) ⭐32
...
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐12779 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
- [AdamPlatin123/awesome-dsh-plugins](https://github.com/AdamPlatin123/awesome-dsh-plugins) ⭐1394 — DSH 插件雷达与精选榜：多路自动发现 9000+ 候选，容器真实安装路径运行级实测（四档判定），精选 Top 50 · 11 类人工策展，全量索引 PLUGINS-ALL.md，自动更新。
...
▶️ [View all 199 plugins →](categories/awesome-lists.md)


### ⚠️ Weakly Related


516 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 516 repos →](categories/weakly-related.md)
