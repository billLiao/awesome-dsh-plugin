...
**930 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 287 | Plugins that enhance the DSH web/terminal user interface. |
...
| 🧠 [Memory](categories/memory.md) | 29 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 242 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |
...
▶️ [View all 287 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 29 plugins →](categories/memory.md)
...
▶️ [View all 242 plugins →](categories/tools-capabilities.md)
