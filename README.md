...
**14214 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
|----------|-------|-------------|
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 3606 | Plugins that enhance the DSH web/terminal user interface. |
| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 271 | Skins, themes, and appearance customization for DSH. |
| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1707 | Session management, message editing, sharing, and conversation tools. |
| 🧠 [Memory](categories/memory.md) | 314 | Persistent memory, knowledge bases, and context retention plugins. |
| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 3322 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |
| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 3076 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| ⚠️ [Weakly Related](categories/weakly-related.md) | 989 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
▶️ [View all 3606 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 1707 plugins →](categories/sessions-messages.md)
...
▶️ [View all 3322 plugins →](categories/tools-capabilities.md)
...
▶️ [View all 3076 plugins →](categories/workflow-automation.md)
...
989 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 989 repos →](categories/weakly-related.md)
