...
**14717 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
|----------|-------|-------------|
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 3763 | Plugins that enhance the DSH web/terminal user interface. |
| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 285 | Skins, themes, and appearance customization for DSH. |
| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1780 | Session management, message editing, sharing, and conversation tools. |
| 🧠 [Memory](categories/memory.md) | 324 | Persistent memory, knowledge bases, and context retention plugins. |
| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 3442 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |
| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 3148 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| 📋 [Awesome Lists & Collections](categories/awesome-lists.md) | 300 | Curated collections and awesome lists of DSH plugins. |
| ⚠️ [Weakly Related](categories/weakly-related.md) | 1016 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
- [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) ⭐7979 — DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
...
▶️ [View all 3763 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 285 plugins →](categories/themes-appearance.md)
...
▶️ [View all 1780 plugins →](categories/sessions-messages.md)
...
▶️ [View all 324 plugins →](categories/memory.md)


### 🛠️ Tools & Capabilities

- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) ⭐28790 — 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) ⭐8948 — DSHDesktop：DeepSeek Harness Desktop / DeepSeek Harness 桌面版
...
▶️ [View all 3442 plugins →](categories/tools-capabilities.md)
...
- [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) ⭐4465 — The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH 可视化插件市场

▶️ [View all 3148 plugins →](categories/workflow-automation.md)
...
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐16778 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
...
▶️ [View all 300 plugins →](categories/awesome-lists.md)


### ⚠️ Weakly Related


1016 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 1016 repos →](categories/weakly-related.md)
