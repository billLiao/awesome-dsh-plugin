...
**9327 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 2260 | Plugins that enhance the DSH web/terminal user interface. |

| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 182 | Skins, themes, and appearance customization for DSH. |

| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1043 | Session management, message editing, sharing, and conversation tools. |

| 🧠 [Memory](categories/memory.md) | 190 | Persistent memory, knowledge bases, and context retention plugins. |

| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 2184 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |

| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 2383 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| ⚠️ [Weakly Related](categories/weakly-related.md) | 486 | Repositories tagged dsh-plugin but with weak relevance signals — may use DeepSeek API or have loose association. |
...
▶️ [View all 2260 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 1043 plugins →](categories/sessions-messages.md)
...
▶️ [View all 190 plugins →](categories/memory.md)
...
▶️ [View all 2184 plugins →](categories/tools-capabilities.md)
...
▶️ [View all 2383 plugins →](categories/workflow-automation.md)
...
486 repositories tagged `dsh-plugin` but with low relevance confidence.


▶️ [View all 486 repos →](categories/weakly-related.md)
