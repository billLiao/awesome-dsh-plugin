...
**14784 plugins** collected from GitHub topic [`dsh-plugin`](https://github.com/topics/dsh-plugin) · [PRs welcome](#contributing)
...
|----------|-------|-------------|
| 🎨 [UI Enhancements](categories/ui-enhancements.md) | 3785 | Plugins that enhance the DSH web/terminal user interface. |
| 🎭 [Themes & Appearance](categories/themes-appearance.md) | 285 | Skins, themes, and appearance customization for DSH. |
| 💬 [Sessions & Messages](categories/sessions-messages.md) | 1795 | Session management, message editing, sharing, and conversation tools. |
| 🧠 [Memory](categories/memory.md) | 325 | Persistent memory, knowledge bases, and context retention plugins. |
| 🛠️ [Tools & Capabilities](categories/tools-capabilities.md) | 3454 | Vision, browser, terminal, SSH, Docker, and other capability extensions. |
| 🔁 [Workflow & Automation](categories/workflow-automation.md) | 3158 | Automation loops, scheduled tasks, multi-agent teams, and workflow engines. |
...
| 🔌 [Models & Providers](categories/models-providers.md) | 78 | Multi-model support, OAuth login, LLM fallback strategies, and provider bridges. |
...
- [zhu1090093659/dsh-web](https://github.com/zhu1090093659/dsh-web) ⭐7993 — DeepSeek Harness (DSH) Web 插件聚合生态 · 万物皆插件，通过创意工坊分发｜｜DeepSeek Harness (DSH) Web Plugin Aggregation Ecosystem · Everything is a plugin, distributed via the Creative Workshop
...
▶️ [View all 3785 plugins →](categories/ui-enhancements.md)
...
▶️ [View all 1795 plugins →](categories/sessions-messages.md)
...
- [anywhere-labs/dsh-desktop](https://github.com/anywhere-labs/dsh-desktop) ⭐28870 — 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。
- [dataelement/dsh-desktop](https://github.com/dataelement/dsh-desktop) ⭐9099 — DSHDesktop：DeepSeek Harness Desktop / DeepSeek Harness 桌面版
...
▶️ [View all 3454 plugins →](categories/tools-capabilities.md)


### 🔁 Workflow & Automation

- [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) ⭐235140 — DeepSeek Harness: Everything is a Plugin.
...
- [dsh-market/dsh-market](https://github.com/dsh-market/dsh-market) ⭐4506 — The plugin market inside DeepSeek Harness — browse, search, one-click install · DSH 可视化插件市场

▶️ [View all 3158 plugins →](categories/workflow-automation.md)
...
▶️ [View all 78 plugins →](categories/models-providers.md)
...
- [awesome-dsh-plugin/awesome-dsh-plugin](https://github.com/awesome-dsh-plugin/awesome-dsh-plugin) ⭐16826 — A curated list of plugins for DeepSeek Harness (dsh) · DeepSeek Harness 插件精选列表
