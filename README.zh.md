...
**14784 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 分类 | 数量 | 说明 |
|------|------|------|
| 🎨 [UI 增强](categories/ui-enhancements.md) | 3785 | 增强 DSH Web/终端用户界面的插件。 |
| 🎭 [主题与外观](categories/themes-appearance.md) | 285 | DSH 皮肤、主题与外观定制。 |
| 💬 [会话与消息](categories/sessions-messages.md) | 1795 | 会话管理、消息编辑、分享与对话工具。 |
| 🧠 [记忆](categories/memory.md) | 325 | 持久记忆、知识库与上下文保留插件。 |
| 🛠️ [工具与能力](categories/tools-capabilities.md) | 3454 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
| 🔁 [工作流与自动化](categories/workflow-automation.md) | 3158 | 自动化循环、定时任务、多智能体团队与工作流引擎。 |
| 🔔 [通知与集成](categories/notifications-integrations.md) | 31 | 微信、Telegram、IM 桥接、桌面通知与外部集成。 |
| 🔌 [模型与账号接入](categories/models-providers.md) | 78 | 多模型支持、OAuth 登录、LLM 回退策略与提供商桥接。 |
...
▶️ [查看全部 3785 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 1795 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 3454 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 3158 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 78 个插件 →](categories/models-providers.md)
