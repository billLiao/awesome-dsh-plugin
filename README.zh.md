...
**1682 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 🎨 [UI 增强](categories/ui-enhancements.md) | 453 | 增强 DSH Web/终端用户界面的插件。 |

| 🎭 [主题与外观](categories/themes-appearance.md) | 39 | DSH 皮肤、主题与外观定制。 |
...
| 🧑‍💻 [开发与运行时](categories/development-runtime.md) | 6 | 插件管理器、SDK、CLI、桌面壳与开发者工具。 |

| 🎮 [娱乐](categories/fun.md) | 2 | 游戏、桌宠、娱乐与趣味插件。 |

| 📋 [精选列表与合集](categories/awesome-lists.md) | 72 | DSH 插件精选列表与合集。 |

| ⚠️ [弱相关](categories/weakly-related.md) | 104 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 453 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 39 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 210 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 46 个插件 →](categories/memory.md)
...
▶️ [查看全部 443 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 238 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 6 个插件 →](categories/development-runtime.md)
...
▶️ [查看全部 72 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


104 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 104 个仓库 →](categories/weakly-related.md)
