...
**14021 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 分类 | 数量 | 说明 |
|------|------|------|
| 🎨 [UI 增强](categories/ui-enhancements.md) | 3551 | 增强 DSH Web/终端用户界面的插件。 |
| 🎭 [主题与外观](categories/themes-appearance.md) | 267 | DSH 皮肤、主题与外观定制。 |
| 💬 [会话与消息](categories/sessions-messages.md) | 1676 | 会话管理、消息编辑、分享与对话工具。 |
| 🧠 [记忆](categories/memory.md) | 310 | 持久记忆、知识库与上下文保留插件。 |
| 🛠️ [工具与能力](categories/tools-capabilities.md) | 3279 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
| 🔁 [工作流与自动化](categories/workflow-automation.md) | 3049 | 自动化循环、定时任务、多智能体团队与工作流引擎。 |
...
| 📋 [精选列表与合集](categories/awesome-lists.md) | 287 | DSH 插件精选列表与合集。 |
| ⚠️ [弱相关](categories/weakly-related.md) | 978 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 3551 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 267 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 1676 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 310 个插件 →](categories/memory.md)
...
▶️ [查看全部 3279 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 3049 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 287 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


978 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 978 个仓库 →](categories/weakly-related.md)
