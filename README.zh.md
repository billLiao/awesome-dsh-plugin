...
**14993 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 分类 | 数量 | 说明 |
|------|------|------|
| 🎨 [UI 增强](categories/ui-enhancements.md) | 3858 | 增强 DSH Web/终端用户界面的插件。 |
...
| ⚠️ [弱相关](categories/weakly-related.md) | 1023 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 3858 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 1834 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 329 个插件 →](categories/memory.md)
...
▶️ [查看全部 3506 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 14 个插件 →](categories/fun.md)
...
1023 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 1023 个仓库 →](categories/weakly-related.md)
