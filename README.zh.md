...
| 🎨 [UI 增强](categories/ui-enhancements.md) | 271 | 增强 DSH Web/终端用户界面的插件。 |
...
| 🛠️ [工具与能力](categories/tools-capabilities.md) | 269 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
...
| 📋 [精选列表与合集](categories/awesome-lists.md) | 47 | DSH 插件精选列表与合集。 |

| ⚠️ [弱相关](categories/weakly-related.md) | 50 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 271 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 269 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 47 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


50 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 50 个仓库 →](categories/weakly-related.md)
