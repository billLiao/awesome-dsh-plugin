...
| 💬 [会话与消息](categories/sessions-messages.md) | 119 | 会话管理、消息编辑、分享与对话工具。 |

| 🧠 [记忆](categories/memory.md) | 26 | 持久记忆、知识库与上下文保留插件。 |

| 🛠️ [工具与能力](categories/tools-capabilities.md) | 241 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
...
| 🧑‍💻 [开发与运行时](categories/development-runtime.md) | 1 | 插件管理器、SDK、CLI、桌面壳与开发者工具。 |

| 🎮 [娱乐](categories/fun.md) | 1 | 游戏、桌宠、娱乐与趣味插件。 |

| 📋 [精选列表与合集](categories/awesome-lists.md) | 34 | DSH 插件精选列表与合集。 |

| ⚠️ [弱相关](categories/weakly-related.md) | 80 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 119 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 241 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 1 个插件 →](categories/development-runtime.md)
...
▶️ [查看全部 34 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


80 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 80 个仓库 →](categories/weakly-related.md)
