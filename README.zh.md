...
| 🛠️ [工具与能力](categories/tools-capabilities.md) | 237 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
...
| ⚠️ [弱相关](categories/weakly-related.md) | 71 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 237 个插件 →](categories/tools-capabilities.md)
...
71 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 71 个仓库 →](categories/weakly-related.md)
