...
**9461 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 🎨 [UI 增强](categories/ui-enhancements.md) | 2303 | 增强 DSH Web/终端用户界面的插件。 |

| 🎭 [主题与外观](categories/themes-appearance.md) | 185 | DSH 皮肤、主题与外观定制。 |

| 💬 [会话与消息](categories/sessions-messages.md) | 1058 | 会话管理、消息编辑、分享与对话工具。 |

| 🧠 [记忆](categories/memory.md) | 196 | 持久记忆、知识库与上下文保留插件。 |

| 🛠️ [工具与能力](categories/tools-capabilities.md) | 2213 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |

| 🔁 [工作流与自动化](categories/workflow-automation.md) | 2398 | 自动化循环、定时任务、多智能体团队与工作流引擎。 |

| 🔔 [通知与集成](categories/notifications-integrations.md) | 15 | 微信、Telegram、IM 桥接、桌面通知与外部集成。 |

| 🔌 [模型与账号接入](categories/models-providers.md) | 49 | 多模型支持、OAuth 登录、LLM 回退策略与提供商桥接。 |

| 🧑‍💻 [开发与运行时](categories/development-runtime.md) | 28 | 插件管理器、SDK、CLI、桌面壳与开发者工具。 |

| 🔒 [安全与隐私](categories/security-privacy.md) | 4 | 凭证管理、加密、审计与安全工具。 |

| 🎮 [娱乐](categories/fun.md) | 9 | 游戏、桌宠、娱乐与趣味插件。 |

| 📋 [精选列表与合集](categories/awesome-lists.md) | 193 | DSH 插件精选列表与合集。 |

| ⚠️ [弱相关](categories/weakly-related.md) | 495 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 2303 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 185 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 1058 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 196 个插件 →](categories/memory.md)
...
▶️ [查看全部 2213 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 2398 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 15 个插件 →](categories/notifications-integrations.md)
...
▶️ [查看全部 49 个插件 →](categories/models-providers.md)
...
▶️ [查看全部 28 个插件 →](categories/development-runtime.md)
...
▶️ [查看全部 193 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


495 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 495 个仓库 →](categories/weakly-related.md)
