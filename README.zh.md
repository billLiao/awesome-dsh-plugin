...
**11852 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
▶️ [查看全部 2938 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 226 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 1353 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 253 个插件 →](categories/memory.md)
...
▶️ [查看全部 2754 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 2730 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 234 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


824 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 824 个仓库 →](categories/weakly-related.md)
