...
**14384 个插件**，来自 GitHub 话题 [`dsh-plugin`](https://github.com/topics/dsh-plugin) · 欢迎 [PR](#贡献)
...
| 分类 | 数量 | 说明 |
|------|------|------|
| 🎨 [UI 增强](categories/ui-enhancements.md) | 3659 | 增强 DSH Web/终端用户界面的插件。 |
| 🎭 [主题与外观](categories/themes-appearance.md) | 276 | DSH 皮肤、主题与外观定制。 |
| 💬 [会话与消息](categories/sessions-messages.md) | 1740 | 会话管理、消息编辑、分享与对话工具。 |
| 🧠 [记忆](categories/memory.md) | 314 | 持久记忆、知识库与上下文保留插件。 |
| 🛠️ [工具与能力](categories/tools-capabilities.md) | 3369 | 视觉、浏览器、终端、SSH、Docker 等能力扩展。 |
| 🔁 [工作流与自动化](categories/workflow-automation.md) | 3090 | 自动化循环、定时任务、多智能体团队与工作流引擎。 |
...
| 🧑‍💻 [开发与运行时](categories/development-runtime.md) | 38 | 插件管理器、SDK、CLI、桌面壳与开发者工具。 |
| 🔒 [安全与隐私](categories/security-privacy.md) | 10 | 凭证管理、加密、审计与安全工具。 |
| 🎮 [娱乐](categories/fun.md) | 12 | 游戏、桌宠、娱乐与趣味插件。 |
| 📋 [精选列表与合集](categories/awesome-lists.md) | 294 | DSH 插件精选列表与合集。 |
...
▶️ [查看全部 3659 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 276 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 1740 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 3369 个插件 →](categories/tools-capabilities.md)
...
▶️ [查看全部 3090 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 38 个插件 →](categories/development-runtime.md)
...
▶️ [查看全部 294 个插件 →](categories/awesome-lists.md)
