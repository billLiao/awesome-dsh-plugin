...
| 🎨 [UI 增强](categories/ui-enhancements.md) | 939 | 增强 DSH Web/终端用户界面的插件。 |

| 🎭 [主题与外观](categories/themes-appearance.md) | 86 | DSH 皮肤、主题与外观定制。 |

| 💬 [会话与消息](categories/sessions-messages.md) | 445 | 会话管理、消息编辑、分享与对话工具。 |
...
| 🔌 [模型与账号接入](categories/models-providers.md) | 11 | 多模型支持、OAuth 登录、LLM 回退策略与提供商桥接。 |

| 🧑‍💻 [开发与运行时](categories/development-runtime.md) | 12 | 插件管理器、SDK、CLI、桌面壳与开发者工具。 |

| 🎮 [娱乐](categories/fun.md) | 4 | 游戏、桌宠、娱乐与趣味插件。 |

| 📋 [精选列表与合集](categories/awesome-lists.md) | 110 | DSH 插件精选列表与合集。 |

| ⚠️ [弱相关](categories/weakly-related.md) | 215 | 标记了 dsh-plugin 但关联性较弱的仓库——可能只是使用了 DeepSeek API 或关联松散。 |
...
▶️ [查看全部 939 个插件 →](categories/ui-enhancements.md)
...
▶️ [查看全部 86 个插件 →](categories/themes-appearance.md)
...
▶️ [查看全部 445 个插件 →](categories/sessions-messages.md)
...
▶️ [查看全部 88 个插件 →](categories/memory.md)
...
▶️ [查看全部 521 个插件 →](categories/workflow-automation.md)
...
▶️ [查看全部 11 个插件 →](categories/models-providers.md)
...
▶️ [查看全部 12 个插件 →](categories/development-runtime.md)
...
▶️ [查看全部 110 个插件 →](categories/awesome-lists.md)


### ⚠️ 弱相关


215 个标记了 `dsh-plugin` 但关联性较低的仓库。


▶️ [查看全部 215 个仓库 →](categories/weakly-related.md)
