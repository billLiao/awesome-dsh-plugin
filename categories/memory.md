...
- [Zephyr-vibe/dsh-personalize](https://github.com/Zephyr-vibe/dsh-personalize) ⭐1 — Per-host personalization for DSH: custom instructions, local long-term memory, and reply-tone presets.
- [elementor-i/dsh-agentmemory](https://github.com/elementor-i/dsh-agentmemory) ⭐1 — agentmemory for DeepSeek Harness (dsh): full memory_* tools, capture hooks, and context injection over the local REST server
...
- [LeslieWylie/dsh-mlamp-ops](https://github.com/LeslieWylie/dsh-mlamp-ops) — Evidence-driven RLVR memory, OctoLoop orchestration, benchmark evidence, and DSH plugin release tools.
...
- [Phant0Meow/dsh-memory-meow](https://github.com/Phant0Meow/dsh-memory-meow)
...
- [flymysql/dsh-memory](https://github.com/flymysql/dsh-memory)
