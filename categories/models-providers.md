...
- [omdsh-dev/dsh-llm-fallbacks](https://github.com/omdsh-dev/dsh-llm-fallbacks) ⭐1 — An dsh plugin for role-based LLM retry&fallback strategy. 基于角色的模型重试备用策略插件
...
- [lingtima/dsh-think-chinese](https://github.com/lingtima/dsh-think-chinese) — DSH 插件：让模型始终用中文进行内部推理与思考（think in Chinese）。
- [Mark-SmallCharlie/dsh-screen-roach](https://github.com/Mark-SmallCharlie/dsh-screen-roach)

---


*Generated on 2026-08-14 · 8 plugins in this category*
