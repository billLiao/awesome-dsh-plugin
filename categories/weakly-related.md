...
- [agentrq/agentrq](https://github.com/agentrq/agentrq) ⭐1113 — AgentRQ: Human-in-loop realtime conversational task manager for AI Agents. Self-hosted! Control your own agents from wherever you want Mobile, Web, Desktop. Designed to work well with your own Claude subscriptions and any harness with ACP support.
...
- [edison7009/EchoBird](https://github.com/edison7009/EchoBird) ⭐3209 — One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI),OpenClaw,Pi,OpenScience,Vibe-Trading,Claude Desktop (3P profile),ChatGPT desktop,OpenCode Desktop,
...
- [GCWing/BitFun](https://github.com/GCWing/OpenBitFun) ⭐2121 — OpenBitFun combines a high-performance agent runtime written in Rust with a polished desktop application. It pairs the depth of a Code Agent with open, general-purpose capabilities for work beyond software development.
...
- [zuorn/Tydora](https://github.com/zuorn/Tydora) ⭐151 — Let Your Ideas Flow — Tydora is a modern desktop Markdown editor combining WYSIWYG editing, bidirectional links, mind maps, and an infinite canvas — empowering deep thinking and effortless expression.
...
- [orziz/odai](https://github.com/orziz/odai) ⭐110 — AI agent 通用任务治理框架：对齐目标与事实，规划和调度能力，守住授权与风险边界，治理任务执行到真实验收与交付。Governance framework for evidence-driven planning, orchestration, and verified delivery.
...
- [strukto-ai/mirage](https://github.com/strukto-ai/mirage) ⭐3618 — The World's First Virtual Terminal for AI Agents
...
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ⭐364 — a coding Agent, rpc plugin, sub-agents, hashline edits, and mcp
...
- [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) ⭐5903 — The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.
...
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) ⭐36595 — Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.
...
- [superdesigndev/treg](https://github.com/superdesigndev/treg) ⭐1352 — OpenRouter for agent tools. Join community here: https://discord.gg/6mQYYfFMAn
...
- [PM-Shawn/Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) ⭐370 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving skills · privacy-first · multi-Harness roadmap · DeepSeek Harness integration in progress
...
- [amruthpillai/reactive-resume](https://github.com/reactive-resume/app) ⭐42456 — A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
...
- [hashgraph-online/hol-guard](https://github.com/hashgraph-online/hol-guard) ⭐591 — Open-source antivirus for AI agents: block risky tools, secret access, prompt injection, malicious packages, MCP servers, plugins, and skills at runtime.
...
- [ZJU-REAL/Polaris](https://github.com/ZJU-REAL/Polaris) ⭐234 — Toward Autonomous Scientific Discovery
...
- [openguardrails/openguardrails](https://github.com/openguardrails/openguardrails) ⭐43 — The vendor-neutral protocol for AI agent safety & security — and the neutral benchmark that ranks the vendors.
...
- [tt-a1i/archify](https://github.com/tt-a1i/archify) ⭐57846 — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
...
- [Tencent/BrowserSkill](https://github.com/Tencent/BrowserSkill) ⭐1929 — Let AI agents use your real, logged-in browser without interrupting your work. CLI + extension for browser automation across any shell-capable AI agent.
...
- [crafter-station/petdex](https://github.com/crafter-station/petdex) ⭐4078 — A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Hermes, OpenCode, Gemini CLI, and more.
...
- [TencentCloud/tencentmeeting-cli](https://github.com/TencentCloud/tencentmeeting-cli) ⭐236 — 腾讯会议命令行工具（CLI），基于腾讯会议开放平台 OAuth2 授权，支持会议管理、录制管理、参会报告等功能。
...
- [zhengzeyong9527-droid/zzy-dsh-prompt-optimizer](https://github.com/zhengzeyong9527-droid/ai-input-enhancer) ⭐2
...
- [titanwings/colleague-skill](https://github.com/titanwings/distilly) ⭐24614 — Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）.
...
- [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) ⭐30016 — Prompt as Code | GPT-Image2 工业级提示词引擎与模板库，530+ 个案例逆向工程，20+ 套工业级模板，并提炼出Skills，持续更新中
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) ⭐22050 — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) ⭐72031 — 🌊 The original agent meta-harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
...
- [nocobase/nocobase](https://github.com/nocobase/nocobase) ⭐24151 — NocoBase is an open-source AI + no-code platform for building business systems fast. Instead of generating everything from scratch, AI works on top of production-proven infrastructure and a WYSIWYG no-code interface, so you get both speed and reliability.
...
- [Unclecheng-li/AI_Animation](https://github.com/Unclecheng-li/AI_Animation) ⭐1268 — 本项目整理了用于生成[炫酷 HTML 动画网页]的 AI Prompts，涵盖动画效果、3D 可视化、PPT 风格演示、UI 美化等多个类别。
...
- [wecode-ai/Wegent](https://github.com/wecode-ai/Wegent) ⭐847 — Plan, build, and deliver with an open-source, self-hostable AI workspace for coding, collaboration, and automation.
...
- [Justin-sky/ai-art-engine](https://github.com/Justin-sky/ai-art-engine) ⭐122 — AI 艺术创作引擎，专业的短视频创作工具
...
- [Scorpio69t/teach-math-with-manim](https://github.com/Scorpio69t/teach-math-with-manim) ⭐3 — Teach Math with Manim — 图书《用 Manim 讲好数学》官方配套开源仓库
...
- [huangruiteng/loopx](https://github.com/huangruiteng/loopx) ⭐5791 — Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.
...
- [plastic-labs/honcho](https://github.com/plastic-labs/honcho) ⭐7111 — Memory library for building stateful agents
...
- [Cosmicwanderer1/lean4-harness-plugin](https://github.com/Cosmicwanderer1/lean4-harness-plugin)
...
*Generated on 2026-09-11 · 881 plugins in this category*
