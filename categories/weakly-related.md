...
- [agentrq/agentrq](https://github.com/agentrq/agentrq) ⭐1088 — AgentRQ: Human-in-loop realtime conversational task manager for AI Agents. Self-hosted! Control your own agents from wherever you want Mobile, Web, Desktop. Designed to work well with your own Claude subscriptions and any harness.
...
- [edison7009/EchoBird](https://github.com/edison7009/EchoBird) ⭐3126 — One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI),OpenClaw,Pi,OpenScience,Vibe-Trading,Claude Desktop (3P profile),ChatGPT desktop,OpenCode Desktop,
- [TuringCorp-net/mosaic_compress](https://github.com/TuringCorp-net/mosaic-memory-compress) ⭐2 — Stateless dialogue compression that mimics human memory. LLM conversations stay bounded forever — no session management, no context overflow.
...
- [GCWing/BitFun](https://github.com/GCWing/BitFun) ⭐1817 — BitFun combines a high-performance agent runtime written in Rust with a polished desktop application. It pairs the depth of a Code Agent with open, general-purpose capabilities for work beyond software development.
...
- [morluto/jacobian](https://github.com/morluto/jacobian) ⭐63 — A universal, atomic library of mathematics and tools for agents to compose them.
- [zuorn/Tydora](https://github.com/zuorn/Tydora) ⭐97 — Let Your Ideas Flow — Tydora is a modern desktop Markdown editor combining WYSIWYG editing, bidirectional links, mind maps, and an infinite canvas — empowering deep thinking and effortless expression.
- [Nagi-ovo/voyager](https://github.com/Nagi-ovo/voyager) ⭐19838 — Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any web UI, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；提示词管理器可用于任意 Web UI，含 DeepSeek Harness。
...
- [FuRongJun-1999/CommonTrustProtocol](https://github.com/FuRongJun-1999/CommonTrustProtocol) ⭐8 — Common Trust Protocol (CTP) 共同信任协议 | Intelligentics 智能论，研究智能系统存续的底层结构条件
- [orziz/odai](https://github.com/orziz/odai) ⭐100 — AI agent 通用任务治理框架：对齐目标与事实，规划和调度能力，守住授权与风险边界，治理任务执行到真实验收与交付。Governance framework for evidence-driven planning, orchestration, and verified delivery.
- [Sikao-Engine/KimiX](https://github.com/Sikao-Engine/KimiX) ⭐111 — The next-gen lightweight coding agent cli
- [freehul/sgme](https://github.com/freehul/sgme) ⭐12 — 你的 AI，从此记得你——拾光记忆引擎，它记得你们聊过的每一件事，还会主动关心你。
...
- [Ikalus1988/MisakaNet](https://github.com/Ikalus1988/MisakaNet) ⭐429 — 📚 A zero-dependency, git-backed micro-lesson library for AI Agents to asynchronously share and search verified debugging experience. Python stdlib only. | https://misakanet.org
...
- [strukto-ai/mirage](https://github.com/strukto-ai/mirage) ⭐3566 — The World's First Unified Virtual Filesystem For AI Agents
...
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ⭐157 — a coding Agent from pi. ∞ providers, sub-agents, hashline edits, and a permission gate
...
- [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) ⭐5650 — The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.
...
- [cosyncing/cosyncing](https://github.com/cosyncing/cosyncing) ⭐27 — Synchronize and Orchestrate agents from CLI to GUI, across desktop to phone.
...
- [fwerkor/local-shell-mcp](https://github.com/fwerkor/local-shell-mcp) ⭐54 — Enables LLM to use a cli environment.
...
- [alib8b8/aflare](https://github.com/alib8b8/aflare) ⭐12 — 个人优先的本地自动化 Agent · AI 与你的数据之间确定且安全的控制层 · 数据不出本地 · 连接你自己的 LLM / 文件 / 笔记 / 数据库（Connector API） · ReAct 推理 · 确定性工作流执行（DAG/WAL/Saga/幂等） · MCP 协议 · 离线可用
...
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) ⭐33280 — Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.
...
- [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) ⭐1120 — Make AI coding agents architecture-aware: baseline-first, evidence-verified, drift-checked, and safe across long tasks.
...
- [superdesigndev/treg](https://github.com/superdesigndev/treg) ⭐614 — OpenRouter for agent tools. Join community here: https://discord.gg/6mQYYfFMAn
- [Leslie-SSS/seeWxapkg](https://github.com/Leslie-SSS/seeWxapkg) ⭐89 — 极简实用的微信小程序反编译 Web 工具
...
- [PM-Shawn/Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) ⭐349 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving skills · privacy-first · multi-Harness roadmap · DeepSeek Harness integration in progress
...
- [amruthpillai/reactive-resume](https://github.com/amruthpillai/reactive-resume) ⭐41729 — A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
...
- [hashgraph-online/hol-guard](https://github.com/hashgraph-online/hol-guard) ⭐479 — Open-source antivirus for AI agents: block risky tools, secret access, prompt injection, malicious packages, MCP servers, plugins, and skills at runtime.
...
- [ZJU-REAL/Polaris](https://github.com/ZJU-REAL/Polaris) ⭐209 — Toward Autonomous Scientific Discovery
...
- [openguardrails/openguardrails](https://github.com/openguardrails/openguardrails) ⭐34 — The vendor-neutral protocol for AI agent safety & security — and the neutral benchmark that ranks the vendors.
...
- [PicGo/PicGo-Core](https://github.com/PicGo/PicGo-Core) ⭐980 — :zap:The ultimate image uploading engine. Both CLI & API supports.
...
- [kobenfang/BigSeedSkill](https://github.com/kobenfang/BigSeedSkill) ⭐1 — 🌱 BigSeed 闪念记录与人生拼图 - 捕捉生活点滴生成人生故事/自传 | Life story, journal, biography, memory keeper
- [kobenfang/BigPlan](https://github.com/kobenfang/BigPlan) ⭐1 — 📋 BigPlan AI产品调研 - 市场/技术/供应链分析，三套产品规格方案 | Product research, market analysis
- [kobenfang/BigLead](https://github.com/kobenfang/BigLead) ⭐2 — 🎯 BigLead 精准客户线索挖掘 - B2B销售获客 | B2B lead generation, sales prospecting
- [kobenfang/BigFood](https://github.com/kobenfang/BigFood) ⭐1 — 🍳 BigFood AI冰箱管家 - 食材识别→菜谱推荐 | Food recognition, recipe recommendation
- [kobenfang/BigFocus](https://github.com/kobenfang/BigFocus) ⭐1 — 🎯 BigFocus 追踪管家 - 商品价格/明星动态/行业追踪 | Price tracking, monitoring, alerts
- [kobenfang/BigFish](https://github.com/kobenfang/BigFish) ⭐1 — 🎣 BigFish AI钓鱼助手 - 钓点分析·鱼情分析·钓点分享 | Fishing spot analysis, fish activity, bait & lure
- [kobenfang/bigA](https://github.com/kobenfang/bigA) ⭐3 — openclaw-skills BigA · A股智能选股（选股分析·量化交易·股票池）
- [kobenfang/Big8](https://github.com/kobenfang/Big8) ⭐1 — ☯ Big8 AI玄学助手 - 看风水·看面相·算八字·查星座·每日一卦·老黄历 | AI fortune-telling: feng shui, face reading, BaZi, zodiac
...
- [tt-a1i/archify](https://github.com/tt-a1i/archify) ⭐16309 — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
...
- [Tencent/BrowserSkill](https://github.com/Tencent/BrowserSkill) ⭐1321 — Let AI agents use your real, logged-in browser without interrupting your work. CLI + extension for browser automation across any shell-capable AI agent.
...
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) ⭐12413 — One portable memory layer for every AI agent: local-first, Markdown-native, user-owned, and self-evolving across apps, tools, and workflows.
...
- [alibaba/anolisa](https://github.com/alibaba/anolisa) ⭐401 — ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) | Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usage and cost.
...
- [alvinunreal/openpets](https://github.com/alvinunreal/openpets) ⭐1119 — Local first, desktop companion platform with animated pets, plugin SDK and coding-agent integrations.
...
- [chuspeeism/dashi-taskboard](https://github.com/chuspeeism/dashi-taskboard) ⭐2571
...
- [alxshelepenok/grove](https://github.com/alxshelepenok/grove) ⭐19 — A formal workflow protocol that keeps AI coding agents on track through machine-enforced invariants, verified evidence, and structured context. Designed to keep deep, long-running projects coherent across sessions, agents, and months.
- [crafter-station/petdex](https://github.com/crafter-station/petdex) ⭐3968 — A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Hermes, OpenCode, Gemini CLI, and more.
...
- [jermaine123123/agent-context-editor](https://github.com/jermaine123123/agent-context-editor) ⭐2 — Cross-agent model-context exclusion with search, filtering, hide/restore, and original Session preservation
...
- [mrpulor-gh/nuphus-mcp](https://github.com/mrpulor-gh/nuphus-mcp) ⭐236 — Desktop automation MCP server — computer use for any AI agent: control screen, windows, mouse/keyboard, and Chrome via Model Context Protocol (stdio)
...
- [mindscale-noah/MindMemOS](https://github.com/mindscale-noah/MindMemOS) ⭐951
...
- [tingly-dev/tingly-box](https://github.com/tingly-dev/tingly-box) ⭐344 — Your Intelligence, Orchestrated. Every builder. Every team. Every agent. For Everyone.
...
- [JingbiaoMei/Tokdash](https://github.com/JingbiaoMei/Tokdash) ⭐63 — Agent Dashboard: Visualization and analytics for Sessions and Quota Usage. Track, analyze, and optimize token usage across providers with heatmaps, cost tracking, token counting and quota resets..
...
- [tong-io/tongflow](https://github.com/tong-io/tongflow) ⭐936 — TongFlow — Multimodal GenAI Studio
...
- [sandbaseai/sandbase-skills](https://github.com/sandbaseai/sandbase-skills) ⭐47 — 88 installable open-source Agent Skills for research, social intelligence, marketing, and business workflows—compatible with Codex, Claude Code, Cursor, Gemini CLI, and DeepSeek Harness.
...
- [TencentCloudBase/CloudBase-AI-Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐1077 — Backend for AI coding agents on CloudBase — database, auth, functions via Plugin, Skills & MCP.
...
- [melandlabs/opencontext](https://github.com/melandlabs/opencontext) ⭐52 — A temporal context graph, a memory API, retrieval primitives, and a multiple-platform integration mesh — designed to be embedded into any host process.
...
- [ddtcorex/agent-dev-skills](https://github.com/ddtcorex/maestro-skills) ⭐3 — Universal AI Agent Development Skills Hub & Cordis Plugin for Govard, Magento 2, Laravel. Works with Claude Code, Codex CLI, OpenCode, GitHub Copilot, DeepSeek Harness.
...
- [taptap/instant-games-open-mcp](https://github.com/taptap/instant-games-open-mcp) ⭐29 — TapTap 小游戏开放能力 mcp
...
- [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) ⭐17098 — Prompt as Code | GPT-Image2 工业级提示词引擎与模板库，530+ 个案例逆向工程，20+ 套工业级模板，并提炼出Skills，持续更新中
...
- [EverMind-AI/SkillCorpus](https://github.com/EverMind-AI/SkillCorpus) ⭐64 — Open-source infrastructure that turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora—with retrieval and evaluation tooling included.
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) ⭐20610 — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki.
...
- [unknowbug/anchorlaw](https://github.com/unknowbug/anchorlaw) ⭐4 — Code verification protocol for vibe coding — every claim must have a verifiable practice anchor.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) ⭐69376 — 🌊 The original agent meta-harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
...
- [398894496-arch/runtime36](https://github.com/398894496-arch/runtime36) ⭐13 — Second brain for coding agents. Seal the day, distill into Obsidian, hit that page tomorrow. Cursor, Codex, Claude Code, DeepSeek Harness.
- [ai-daming/clickvibe](https://github.com/ai-daming/clickvibe) ⭐10
...
- [nocobase/nocobase](https://github.com/nocobase/nocobase) ⭐23844 — NocoBase is an open-source AI + no-code platform for building business systems fast. Instead of generating everything from scratch, AI works on top of production-proven infrastructure and a WYSIWYG no-code interface, so you get both speed and reliability.
...
- [zrk222/code-factory](https://github.com/zrk222/code-factory) ⭐5 — Catch AI-generated tests that could never fail; wrap agent changes in local proof and evidence. Free core; proposed evidence-gated enterprise support SLA.
- [mokuyoaxis/agent-guard](https://github.com/mokuyoaxis/agent-guard) ⭐1 — Make destructive AI-agent actions reversible by default — quarantine + audit + human escalation for rm/git destructive operations. Reliability infrastructure, not a sandbox.
...
- [taxueseek/argo](https://github.com/taxueseek/argo) ⭐108 — 专门为 agent 打造的 agent 搜索工具，具备多语言搜索能力，覆盖中文/英文/学术/代码/购物/金融/新闻/百科。
- [Akimiya-z/codex-guard](https://github.com/Akimiya-z/codex-guard) ⭐49 — Quality gate for AI/Codex-generated pull requests: blocks TODO leftovers, leaked secrets, sloppy commits and red CI before they reach main.
...
- [jinxlux/xiao-theme-dsh-ui-plugin](https://github.com/jinxlux/xiao-theme-dsh-ui-plugin)
...
- [chenbin-dev/dsh-scan-mcp](https://github.com/chenbin-dev/dsh-scan-mcp) — 能够扫描本地claudecode、codex、codebuddy等Agent配置过的mcp工具的插件
- [xi-zhao/OpenQuantum](https://github.com/xi-zhao/OpenQuantum) ⭐46 — Open-source quantum Agent workspace with a desktop client, Web UI, messaging, Qiskit/MCP tools, and scientific validation
...
- [agentscope-ai/ReMe](https://github.com/agentscope-ai/ReMe) ⭐3340 — ReMe: Memory Management Kit for Agents - Remember Me, Refine Me.
...
- [hanshanxue83/collaborative-emergent-intelligence](https://github.com/hanshanxue83/collaborative-emergent-intelligence)
- [volcengine/ark-cli](https://github.com/volcengine/ark-cli) ⭐108 — The fastest way to put Volcengine Ark in your terminal and your AI agent — go from prompt to generated   media, multimodal answer, or deployed endpoint in a single command, no API glue code.
- [JingxuanC/causal-memory](https://github.com/JingxuanC/causal-memory) ⭐49 — Causal memory layer for AI agents — MCP server that records decision→outcome relationships. Survives compaction.
...
- [phoenixlucky/zerotoken-skill](https://github.com/phoenixlucky/zerotoken-skill) ⭐13 — 让 Agent 高效又守纪律 — 不止省 token：ZeroToken 压缩无效上下文/推理/输出；尉缭子十原则约束权限边界、单一指令、先谋后动、验证先于结束；附 Unicode 编码规范、搜索规范、六种任务模式。More than token savings: ZeroToken efficiency + AI coding discipline for Reasonix / Codex / OpenCode / Hermes
...
- [rayadesune/DeepSeek-Harness-chat-billing](https://github.com/rayadesune/DeepSeek-Harness-chat-billing) ⭐1 — 类原生计费插件
- [toby-bridges/api-relay-audit](https://github.com/toby-bridges/api-relay-audit) ⭐805 — Local security audit for AI API relays and LLM proxies: detects prompt injection, model substitution, tool-call rewriting, SSE anomalies, error leakage, and Web3 wallet risks.
...
- [AgentDebugX/AgentDebugX](https://github.com/AgentDebugX/AgentDebugX) ⭐50 — A debugging framework for agentic AI systems: diagnose failures, attribute root causes, recover with evidence, and validate fixes through reruns.
...
- [boheastill/phone-eye](https://github.com/boheastill/phone-eye) — Let your AI agent see and operate a real Android phone — vision + UI-tree fusion over adb, for any MCP client (Claude Code, Codex, dsh…)
...
- [luxueliu/luxueliu-dsh-md-writing-tools](https://github.com/luxueliu/luxueliu-dsh-md-writing-tools)
...
*Generated on 2026-08-26 · 511 plugins in this category*
