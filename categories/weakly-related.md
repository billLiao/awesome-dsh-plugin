...
- [edison7009/EchoBird](https://github.com/edison7009/EchoBird) ⭐3221 — One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI),OpenClaw,Pi,OpenScience,Vibe-Trading,Claude Desktop (3P profile),ChatGPT desktop,OpenCode Desktop,
...
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ⭐389 — a coding agent, rpc plugin, sub-agents, hashline edits, and mcp
...
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) ⭐36965 — Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.
...
- [superdesigndev/treg](https://github.com/superdesigndev/treg) ⭐1390 — OpenRouter for agent tools. Join community here: https://discord.gg/6mQYYfFMAn
...
- [sopaco/terrain](https://github.com/sopaco/terrain) ⭐158 — AI-native engineering environment management that makes your codebase agent-ready.
...
- [dqsjqian/Aria](https://github.com/dqsjqian/Aria) ⭐85 — Modern MVVM framework supporting C++23 (C++20 minimum) — cross-platform, layered, coroutine-first. Reactive DAG (Property/Computed/Effect), Task<T>, and pluggable adapters.
...
- [Vladimir-Human/ru-marketplace-mcp](https://github.com/Vladimir-Human/ru-marketplace-mcp) ⭐98 — Одиннадцать маркетплейсов и недвижимость Циан как MCP-серверы: Wildberries, Ozon, Яндекс Маркет, Детский мир, Авито, AliExpress, Taobao, Мегамаркет, Lamoda, DNS, Ситилинк, Циан. Плюс сравнение цен по всем товарным источникам одним вызовом. Только чтение, ключи не нужны.
...
- [xiaods/k8e](https://github.com/xiaods/k8e) ⭐488 — k8e.sh - OpenSource Agentic AI Sandbox Matrix
...
- [tt-a1i/archify](https://github.com/tt-a1i/archify) ⭐60419 — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) ⭐22806 — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) ⭐72285 — 🌊 The original agent harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, federation, vector RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
...
- [huangruiteng/loopx](https://github.com/huangruiteng/loopx) ⭐5830 — Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.
...
- [ciyuan1234/MCM_skills](https://github.com/ciyuan1234/MCM_skills) ⭐9 — 数学建模通用skills
...
- [sopaco/deepwiki-rs](https://github.com/sopaco/deepwiki-rs) ⭐2643 — Turn code into clarity. Generate accurate technical docs and AI-ready context in minutes—perfectly structured for human teams and intelligent agents.

---


*Generated on 2026-09-14 · 899 plugins in this category*
