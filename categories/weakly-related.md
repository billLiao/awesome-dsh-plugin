...
- [hellogit2021/avoid-ai-writing-cn](https://github.com/hellogit2021/avoid-ai-writing-cn) ⭐2 — 知乎"去AI味写作技巧"社区免费提供：中文写作去 AI 味插件。说"去掉AI味"即重写，说"写的不错"自动学习新 AI 词。
- [liangyou09/lyshell-archive](https://github.com/liangyou09/lyshell-archive) ⭐6 — AI-native terminal & SSH client — Harness launches DeepSeek / CodEx / Claude agents on PowerShell 7 in TUI or embedded Web UI, plus SFTP, serial/Telnet and a built-in MCP server.
- [querit-ai/querit-plugins](https://github.com/querit-ai/querit-plugins) ⭐8 — Official Querit integrations for AI agents: real-time, cited web search and page fetch for Pi, DSH, OpenCode, Claude Code, n8n, Zapier, and Browserbase.
- [Tiger3807861189/GLM-5.3-Flash-J-Space-Capability-Realization-Report](https://github.com/Tiger3807861189/GLM-5.3-Flash-J-Space-Capability-Realization-Report) ⭐1023 — GLM-5.3-Flash × J-Space capability realization — benchmark presentation of the J-Space Cognition Suite
- [Innocent-children/dev-flow](https://github.com/Innocent-children/dev-flow) ⭐7 — Long-running AI coding, under control. Durable State · Explicit Scope · Bounded Verification · Safe Recovery
...
- [dabaicai001/star-dsh-desktop](https://github.com/dabaicai001/star-dsh-desktop) ⭐11 — StarHub — All-in-One DevOps Desktop Command Center。把开发运维每天要用到的工具收进同一个窗口:数据库客户端 · SSH 终端 · SFTP · Docker · AI 助手,以及 AI 驱动的沙箱桌面与 Android 实体机操作。
- [sandbaseai/sandbase-harness](https://github.com/sandbaseai/sandbase-harness) ⭐645 — Local-first, self-hosted AI agent runtime and MCP bridge with sandboxed sessions, memory, credentials, audit/replay, and a local Console.
- [Hilbert-beinghappy/seektty](https://github.com/Hilbert-beinghappy/seektty) ⭐198 — 面向 DeepSeek Harness 的 Claude Code 风格终端界面，支持 Windows、macOS 与 Linux，兼容透明终端、VS Code 主题和自定义配色。
- [fishzjp/qa-skills](https://github.com/fishzjp/qa-skills) ⭐27 — 让 AI 像资深测试工程师一样工作：面向 AI Agent 的测试工程 Skill 框架——11 Skills + 共享知识库 + 类型决策矩阵（Claude Code / dsh 等 Agent 可用）
...
- [edison7009/EchoBird](https://github.com/edison7009/EchoBird) ⭐3238 — One-click install + model switch:Claude Code,Codex CLI (OpenAI), Grok Build (xAI), DeepSeek Harness, Kimi Code (Moonshot) ,Qwen Code,Aider,OpenCode,MiMo Code (Xiaomi),ZCode (Z.AI),OpenClaw,Pi,OpenScience,Vibe-Trading,Claude Desktop (3P profile),ChatGPT desktop,OpenCode Desktop,
...
- [GCWing/OpenBitFun](https://github.com/GCWing/OpenBitFun) ⭐2258 — OpenBitFun combines a high-performance agent runtime written in Rust with a polished desktop application. It pairs the depth of a Code Agent with open, general-purpose capabilities for work beyond software development.
...
- [morluto/jacobian](https://github.com/morluto/jacobian) ⭐191 — Composable mathematics tools for agents
- [zuorn/Tydora](https://github.com/zuorn/Tydora) ⭐169 — Let Your Ideas Flow — Tydora is a modern desktop Markdown editor combining WYSIWYG editing, bidirectional links, mind maps, and an infinite canvas — empowering deep thinking and effortless expression.
- [Nagi-ovo/voyager](https://github.com/Nagi-ovo/voyager) ⭐20079 — Enhancement suite for Gemini, AI Studio, Claude & ChatGPT — plus a prompt manager for any websites, DeepSeek Harness included. / 面向 Gemini、AI Studio、Claude 与 ChatGPT 的增强套件；其中的提示词管理器可用于任意网站，如 DeepSeek Harness。
...
- [orziz/odai](https://github.com/orziz/odai) ⭐111 — AI agent 通用任务治理框架：对齐目标与事实，规划和调度能力，守住授权与风险边界，治理任务执行到真实验收与交付。Governance framework for evidence-driven planning, orchestration, and verified delivery.
...
- [strukto-ai/mirage](https://github.com/strukto-ai/mirage) ⭐3639 — The World's First Virtual Terminal for AI Agents
...
- [Ariestar/sivtr](https://github.com/Ariestar/sivtr) ⭐272 — A unified agent memory workspace for human and agent | 一个统一的agent记忆工作空间
- [XJungit/seeker-craft](https://github.com/XJungit/seeker-craft) ⭐1 — An LLM-driven Minecraft bot that beats the Ender Dragon. Rust + Azalea protocol client, 44 tools, 23-tier task system.
...
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ⭐414 — a coding agent, rpc plugin, sub-agents, hashline edits, and mcp
- [N0zoM1z0/th08](https://github.com/N0zoM1z0/th08) ⭐65 — Source reconstruction of Touhou Eiyashou (TH08) 1.00d
- [YaoApp/yao](https://github.com/YaoApp/yao) ⭐7965 — ✨ All your agents and workspaces in one place, on every device you own. Track tasks on a board, accessible from desktop, mobile, browser, or API. Self-hosted.
- [WOOK98/airesearch-plugin](https://github.com/WOOK98/airesearch-plugin)
- [linhay/harmony-next.skills](https://github.com/linhay/harmony-next.skills) ⭐349 — Offline HarmonyOS NEXT developer skill library for AI coding assistants. Covers API 12–26 declarations, ArkTS/ArkUI, NDK, DevEco Studio, emulator automation, debugging, publishing, and reproducible local tooling.
...
- [tinqiao-oss/engramory](https://github.com/tinqiao-oss/engramory) ⭐188 — A portable memory protocol for AI agents — load it as standing rules; a curation discipline + reference spec + optional cap hook.
- [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) ⭐5952 — The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.
...
- [cofy-x/axern](https://github.com/cofy-x/axern) ⭐65 — Secure, reproducible sandboxes for AI agent evaluation, training, and data synthesis.
...
- [fwerkor/local-shell-mcp](https://github.com/fwerkor/local-shell-mcp) ⭐70 — Enables LLM to use a cli environment.
...
- [alib8b8/aflare](https://github.com/alib8b8/aflare) ⭐13 — Local-first automation Agent & deterministic workflow engine — the secure control layer between AI and your data. Data stays local. Connect your own LLM / files / notes / databases via Connector API. ReAct reasoning · DAG/WAL/Saga/idempotent execution · MCP · offline-capable.
- [baobaolaodie/cc-dsh-notifier](https://github.com/baobaolaodie/cc-dsh-notifier) — Windows desktop notifications for Claude Code and DeepSeek Harness sessions. Click any toast to restore the session window — unlike similar tools that only notify without focus actions. Zero external npm dependencies.
...
- [weishao2/tizhuang-agent-skills](https://github.com/weishao2/tizhuang-agent-skills) ⭐16 — 2000万+中小学K12真题题库 Skill：免费注册、免费抽题、教材/章节/知识点检索、练习测验与AI智能组卷。
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) ⭐37829 — Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.
...
- [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) ⭐1200 — Make AI coding agents architecture-aware: baseline-first, evidence-verified, drift-checked, and safe across long tasks.
- [mnemon-dev/mnemon](https://github.com/mnemon-dev/mnemon) ⭐579 — LLM-supervised persistent memory for AI agents — graph-based recall, cross-session knowledge, single binary. Works with DeepSeek Harness, Claude Code, OpenClaw, and any agent runtime.
...
- [superdesigndev/treg](https://github.com/superdesigndev/treg) ⭐1552 — OpenRouter for agent tools. Join community here: https://discord.gg/6mQYYfFMAn
- [Leslie-SSS/seeWxapkg](https://github.com/Leslie-SSS/seeWxapkg) ⭐102 — 极简实用的微信小程序反编译 Web 工具
- [AtlasCloudAI/mcp-server](https://github.com/AtlasCloudAI/mcp-server) ⭐8 — MCP server for Atlas Cloud - AI API aggregation platform for image/video generation and LLM
...
- [sopaco/terrain](https://github.com/sopaco/terrain) ⭐200 — AI-native engineering environment management that makes your codebase agent-ready.
...
- [v587d/capital-generation](https://github.com/v587d/capital-generation) ⭐8 — 面向中国股市散户的金融投资智能体。Next-Gen AI-Driven Capital Generation.
- [dqsjqian/Aria](https://github.com/dqsjqian/Aria) ⭐89 — Modern MVVM framework supporting C++23 (C++20 minimum) — cross-platform, layered, coroutine-first. Reactive DAG (Property/Computed/Effect), Task<T>, and pluggable adapters.
...
- [PM-Shawn/Abu-Cowork](https://github.com/PM-Shawn/Abu-Cowork) ⭐377 — Open-source alternative to Claude Cowork — a local-first AI agent desktop app · multi-model · self-evolving skills · privacy-first · multi-Harness roadmap · DeepSeek Harness integration in progress
...
- [dqsjqian/AriaAgent](https://github.com/dqsjqian/AriaAgent) ⭐4 — Industrial-grade C++20 Agent Tooling Framework GUI — provider-agnostic LLM agent with true SSE streaming, tool registry, approval gate. Built on Aria (C++20 MVVM).
- [Vladimir-Human/ru-marketplace-mcp](https://github.com/Vladimir-Human/ru-marketplace-mcp) ⭐101 — Одиннадцать маркетплейсов и недвижимость Циан как MCP-серверы: Wildberries, Ozon, Яндекс Маркет, Детский мир, Авито, AliExpress, Taobao, Мегамаркет, Lamoda, DNS, Ситилинк, Циан. Плюс сравнение цен по всем товарным источникам одним вызовом. Только чтение, ключи не нужны.
...
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) ⭐43068 — A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
...
- [hashgraph-online/hol-guard](https://github.com/hashgraph-online/hol-guard) ⭐623 — Open-source antivirus for AI agents: block risky tools, secret access, prompt injection, malicious packages, MCP servers, plugins, and skills at runtime.
...
- [CoaseEdge/AgentNavi](https://github.com/CoaseEdge/AgentNavi) ⭐6 — The navigation of AI Agent.
...
- [possible055/agentshim](https://github.com/possible055/agentshim) ⭐3 — High-performance, capability-aware repository tools and process execution for coding agents.
...
- [ChongCyrus/Vibe-Mathematics](https://github.com/ChongCyrus/Vibe-Mathematics) ⭐21 — Vibe Mathematics —— 多代理数学问题求解与形式化验证框架
...
- [ZJU-REAL/Polaris](https://github.com/ZJU-REAL/Polaris) ⭐238 — Toward Autonomous Scientific Discovery
...
- [xiaods/k8e](https://github.com/xiaods/k8e) ⭐494 — k8e.sh - OpenSource Agentic AI Sandbox Matrix
...
- [syncable-dev/memtrace-public](https://github.com/syncable-dev/memtrace-public) ⭐472 — Structural memory for AI coding agents. Bi-temporal graph, MCP-native, zero LLM calls. Cursor · Claude Code · Codex · DeepSeek Harness · Hermes · VS Code · Windsurf.
...
- [tt-a1i/archify](https://github.com/tt-a1i/archify) ⭐65278 — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
...
- [Tencent/BrowserSkill](https://github.com/Tencent/BrowserSkill) ⭐3409 — Let AI agents use your real, logged-in browser without interrupting your work. CLI + extension for browser automation across any shell-capable AI agent.
...
- [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) ⭐12832 — One portable memory layer for every AI agent: local-first, Markdown-native, user-owned, and self-evolving across apps, tools, and workflows.
...
- [agentic-os-org/ANOLISA](https://github.com/agentic-os-org/ANOLISA) ⭐615 — ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) | Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usage and cost.
...
- [upstash/skills](https://github.com/upstash/skills) ⭐25 — Collection of skills for Upstash
...
- [OpenPetsHQ/openpets](https://github.com/OpenPetsHQ/openpets) ⭐1203 — Local first, desktop companion platform with animated pets, plugin SDK and coding-agent integrations.
...
- [morlay/better-session](https://github.com/morlay/better-session) ⭐10 — better session
- [q2224273481-afk/cc-dsh-desktop](https://github.com/q2224273481-afk/cc-dsh-desktop) ⭐1 — DSH 桌面壳
- [rrrrrredy/beforedone](https://github.com/rrrrrredy/beforedone) ⭐2 — Require fresh, file-bound verification evidence before coding agents declare completion.
...
- [pgmi-builds/corti](https://github.com/pgmi-builds/corti) — Persistent memory layer for AI agent swarms. Postgres-backed retrieval, Markdown as source of truth, sub-second cascade sync. Self-hosted.
...
- [BolunHan/cc-monitor](https://github.com/BolunHan/cc-monitor) ⭐2 — claude code and deepseek harness stats monitor | CC, DSH 状态监控赛博红绿灯
...
- [alxshelepenok/grove](https://github.com/alxshelepenok/grove) ⭐23 — A formal workflow protocol that keeps AI coding agents on track through machine-enforced invariants, verified evidence, and structured context. Designed to keep deep, long-running projects coherent across sessions, agents, and months.
- [crafter-station/petdex](https://github.com/crafter-station/petdex) ⭐4102 — A public gallery of animated pets for Codex, Claude Code, DeepSeek Harness, Hermes, OpenCode, Gemini CLI, and more.
...
- [TencentCloud/tencentmeeting-cli](https://github.com/TencentCloud/tencentmeeting-cli) ⭐237 — 腾讯会议命令行工具（CLI），基于腾讯会议开放平台 OAuth2 授权，支持会议管理、录制管理、参会报告等功能。
...
- [zhengzeyong9527-droid/ai-input-enhancer](https://github.com/zhengzeyong9527-droid/ai-input-enhancer) ⭐1
- [AtlasCloudAI/cli](https://github.com/AtlasCloudAI/cli) ⭐4 — AtlasCloud CLI installers and release artifacts
- [dqsjqian/agent-guild](https://github.com/dqsjqian/agent-guild) ⭐5 — A protocol that lets any sufficiently intelligent AI agent join your shared memory by simply reading one file.
- [Viy1204/recruiting-copilot](https://github.com/Viy1204/recruiting-copilot) ⭐52 — 给 HR / 猎头的 AI 招聘工作流：岗位标准梳理、Boss直聘 + 猎聘双通道寻源初筛、市场人才盘点、简历评估、约面试、候选人台账与日报。可装成 Claude Code 插件或 DeepSeek Harness (dsh) 插件——后者自带可直接上手操作的「招聘浏览器」面板；也能配合任意读 AGENTS.md 的 AI 编程助手使用。
- [rrrrrredy/agent-memory-system](https://github.com/rrrrrredy/agent-memory-system) ⭐1 — Local-first, evidence-backed continuous memory for coding agents
- [vibe-any/awesome-skills](https://github.com/vibe-any/awesome-skills) — awesome skills for any agent
- [jermaine123123/agent-context-editor](https://github.com/jermaine123123/agent-context-editor) ⭐61 — Cross-agent plugin for manually excluding and editing AI conversation context, with search, filtering, hide/restore, undo, and original Session preservation.
...
- [mindscale-noah/MindMemOS](https://github.com/mindscale-noah/MindMemOS) ⭐973
...
- [JingbiaoMei/Tokdash](https://github.com/JingbiaoMei/Tokdash) ⭐76 — Agent Dashboard: Visualization and analytics for Sessions and Quota Usage. Track, analyze, and optimize token usage across providers with heatmaps, cost tracking, token counting and quota resets..
...
- [Sjkhx/yukinoDigital](https://github.com/Sjkhx/yukinoDigital) ⭐5
...
- [tong-io/tongflow](https://github.com/tong-io/tongflow) ⭐1020 — Modality-First GenAI Platform
- [titanwings/distilly](https://github.com/titanwings/distilly) ⭐24799 — Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）.
...
- [TencentCloudBase/CloudBase-AI-Toolkit](https://github.com/TencentCloudBase/CloudBase-AI-Toolkit) ⭐1113 — Backend for AI coding agents on CloudBase — database, auth, functions via Plugin, Skills & MCP.
...
- [sjh9714/cover-my-repo](https://github.com/sjh9714/cover-my-repo) ⭐4 — Agent skill that designs your GitHub social preview (og:image) as one self-contained HTML file. Five moods, CJK-first, deterministic checks, PNG export. repo cover, opengraph, link card.
...
- [melandlabs/opencontext](https://github.com/melandlabs/opencontext) ⭐76 — A temporal context graph, a memory API, retrieval primitives, and a multiple-platform integration mesh — designed to be embedded into any host process.
- [myg133/anspire-ai-search](https://github.com/myg133/anspire-ai-search)
- [BrokkAi/bifrost](https://github.com/BrokkAi/bifrost) ⭐11 — Multi-language static analysis for agents, editors, and large repositories.
...
- [mem9-ai/mem9](https://github.com/mem9-ai/mem9) ⭐1216 — Unlimited memory for OpenClaw
- [sakikoTGW/pack-agent](https://github.com/sakikoTGW/pack-agent) ⭐2 — Agent Modpack — 像装 MC 整合包一样，装你的 agent。
- [zhangjunjesse/dsh-claude-code](https://github.com/zhangjunjesse/dsh-claude-code) ⭐2
...
- [VinsonWild/Wangdefa.Memory](https://github.com/VinsonWild/Wangdefa.Memory) ⭐3 — Wangdefa.Memory 是一个为本地数字分身Agent 设计的五层记忆体组件，数据完全保留在本地，不依赖云端，达到轻量、白盒可控、可解释，未来将进一步往企业级原生记忆体方向拓展。
...
- [taptap/instant-games-open-mcp](https://github.com/taptap/instant-games-open-mcp) ⭐35 — TapTap 小游戏开放能力 mcp
- [MiaoQichuan/new-litigation-visualization](https://github.com/MiaoQichuan/new-litigation-visualization) ⭐56 — 把法律画出来 · Make the Law Visible —— 给法律人的诉讼可视化工具集：把凌乱的诉讼图重画成能进材料的图，直接读案件材料画准一张时间轴，并提供庭前三大法宝（大事记表、庭审对抗图、法律关系图）。Claude Skill / DeepSeek Harness 通用。
...
- [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) ⭐31400 — Prompt as Code | GPT Image 2 / 2.5 提示词与案例库，530+ 个案例、20+ 套工业级模板与可复用 Skills，新增 2.5 同提示词对比专区，附完整提示词与生成记录，持续更新。
...
- [jiujiezongheti/zen-useragent](https://github.com/jiujiezongheti/zen-useragent) ⭐8
...
- [houyanchao/chatgpt-gemini-timeline](https://github.com/houyanchao/chatgpt-gemini-timeline) ⭐441 — ChatGPT & Gemini：Add Folders, Timeline & Prompts. - 为 ChatGPT & Gemini 添加文件夹、提示词库和时间轴。
...
- [hyhmrright/brooks-lint](https://github.com/hyhmrright/brooks-lint) ⭐1474 — AI code reviews grounded in 12 classic engineering books — decay risk diagnostics with book citations, severity labels, and 6 analysis modes including full-sweep auto-fix
...
- [EverMind-AI/SkillCorpus](https://github.com/EverMind-AI/SkillCorpus) ⭐647 — Open-source infrastructure that turns scattered SKILL.md files into curated, retrieval-ready agent-skill corpora—with retrieval and evaluation tooling included.
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) ⭐25755 — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki.
...
- [derekhu0002/archgraph](https://github.com/derekhu0002/archgraph) ⭐3 — An architecture-graph driven framework for Agentic Engineering.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) ⭐72662 — 🌊 The original agent harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, federation, vector RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
...
- [ai-daming/clickvibe](https://github.com/ai-daming/clickvibe) ⭐14
...
- [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) ⭐27113 — :rocket: The Ultimate Image Uploader for Efficient Creators. Supports Obsidian, Typora, VS Code etc. and 60+ image hosting services  (S3, GitHub, Cloudflare R2, Imgur, Aliyun OSS...). Paste, upload, done.
...
- [mokuyoaxis/agent-guard](https://github.com/mokuyoaxis/agent-guard) ⭐3 — Make destructive AI-agent actions reversible by default — quarantine + audit + human escalation for rm/git destructive operations. Reliability infrastructure, not a sandbox.
...
- [sidleo/agent-instructions-plus](https://github.com/sidleo/agent-instructions-plus) ⭐1
...
- [taxueseek/argo](https://github.com/taxueseek/argo) ⭐139 — 专门为 agent 打造的开源 agent 搜索工具，具备 200+的搜索源及多语言搜索能力，覆盖中文/英文/学术/代码/购物/金融/新闻/百科。
- [Akimiya-z/codex-guard](https://github.com/Akimiya-z/codex-guard) ⭐119 — Quality gate for AI/Codex-generated pull requests: blocks TODO leftovers, leaked secrets, sloppy commits and red CI before they reach main.
...
- [yohanchen1/MathModelingAgent](https://github.com/yohanchen1/MathModelingAgent) ⭐4 — Closed-loop scientific modeling agent with evidence-backed verification and reproducible correction.
...
- [syncended/deepseek-harness-automations](https://github.com/syncended/deepseek-harness-automations) ⭐1
- [baobaolaodie/flow-comet](https://github.com/baobaolaodie/flow-comet) ⭐1 — An automated execution engine that turns AI coding discipline into a verifiable state machine — for the flow-kit 9-stage workflow, built for Claude Code, Codex, and DeepSeek Harness.
...
- [phuongddx/jarvis](https://github.com/phuongddx/jarvis) ⭐4 — JARVIS is an intelligent layer that gives agents access to their code, knowledge, context, memory, tools, and runtime — starting locally on your machine, with the ability to extend into the cloud.
...
- [yxy050208/multisim-mcp](https://github.com/yxy050208/multisim-mcp) ⭐13 — Unofficial MCP server for AI-driven NI Multisim circuit generation, simulation, data export, and reports
- [chenbin-dev/dsh-scan-mcp](https://github.com/chenbin-dev/dsh-scan-mcp) ⭐1 — 能够扫描本地claudecode、codex、codebuddy等Agent配置过的mcp工具的插件
- [xi-zhao/OpenQuantum](https://github.com/xi-zhao/OpenQuantum) ⭐50 — Open-source quantum Agent workspace with a desktop client, Web UI, messaging, Qiskit/MCP tools, and scientific validation
...
- [SepineTam/mcp-for-stata](https://github.com/SepineTam/mcp-for-stata) ⭐259 — A MCP server for integrating Stata into your agent loop with a safety-first design.
...
- [agentscope-ai/ReMe](https://github.com/agentscope-ai/ReMe) ⭐3482 — ReMe: Memory Management Kit for Agents - Remember Me, Refine Me.
...
- [volcengine/ark-cli](https://github.com/volcengine/ark-cli) ⭐130 — The fastest way to put Volcengine Ark in your terminal and your AI agent — go from prompt to generated   media, multimodal answer, or deployed endpoint in a single command, no API glue code.
- [JingxuanC/causal-memory](https://github.com/JingxuanC/causal-memory) ⭐71 — Causal memory layer for AI agents — MCP server that records decision→outcome relationships. Survives compaction.
...
- [Azzygoatcoder/agent-useful-skills](https://github.com/Azzygoatcoder/agent-useful-skills) ⭐7 — 模块化 AI 科研/工程技能 monorepo（DeepSeek Harness / Claude Code 通用）— plugins/ + skills/ + bin 脚本 + LaTeX 模板，验证环驱动
- [hanelalo/browser-bridge](https://github.com/hanelalo/browser-bridge) ⭐44 — 让你的agent真的像你一样操控你的浏览器窗口
- [lizhiyao/oh-my-knowledge](https://github.com/lizhiyao/oh-my-knowledge) ⭐22 — OMK — Evidence-backed evaluation and observability for prompts, RAG, skills, agents, and workflows. Native Codex, Claude Code, and DeepSeek Harness support.
...
- [chipweaver/veripower](https://github.com/chipweaver/veripower) ⭐6 — An open-source agent flow from natural language spec through Verilog RTL and UVM verification to front-end signoff on commercial EDA tools
...
- [toby-bridges/api-relay-audit](https://github.com/toby-bridges/api-relay-audit) ⭐838 — Local security audit for AI API relays and LLM proxies: detects prompt injection, model substitution, tool-call rewriting, SSE anomalies, error leakage, and Web3 wallet risks.
...
- [Castor6/BrowserRig](https://github.com/Castor6/BrowserRig) ⭐2 — Open-source local driver for trusted agents to control your existing signed-in Chromium browser without browser-wide remote-debugging approval.
- [yogsoth-ai/de-anthropocentric-research-engine](https://github.com/yogsoth-ai/de-anthropocentric-research-engine) ⭐481 — 900+ pure-markdown skills for autonomous AI research, organized as 9 freely-composable packages over a 4-layer hierarchy (Campaign → Strategy → Tactic → SOP). Non-linear orchestration with backtracking, 6 MCP integrations. The AI is the researcher — you set the direction.
...
- [shuguang1994/project-blueprint](https://github.com/shuguang1994/project-blueprint) ⭐20 — Make any project AI-agent-ready in one command. Adaptive tech stack detection (7 languages × 14 frameworks × 61 components), auto-generates AGENTS.md, docs skeleton, CI/CD, and testing infrastructure. 一句话让任何项目具备 AI 开发能力。
...
- [platonai/Browser4](https://github.com/platonai/Browser4) ⭐1136 — Browser4 — an AI-native browser engine for autonomous agents, intelligent extraction, and large-scale web automation.
...
- [FrankHu-HK/mnemosyne](https://github.com/FrankHu-HK/mnemosyne) ⭐32 — Mnemosyne OS 7.0.1 — zero-dependency, local-first AI memory system (MCP / API / CLI / Python). MIT.
...
- [liwuzhan/cad-tool](https://github.com/liwuzhan/cad-tool) ⭐1
...
- [zilliztech/memsearch](https://github.com/zilliztech/memsearch) ⭐2598 — A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Codex, DSH), backed by Markdown and Milvus.
- [ddtcorex/govard](https://github.com/ddtcorex/govard) ⭐14 — Go-based local development orchestrator for Magento, Laravel, Symfony, Next.js, WordPress, and more. Docker stacks, SSL, Xdebug, and a desktop dashboard.
...
- [xby-skill/xby-web-research-assistant](https://github.com/xby-skill/xby-web-research-assistant) — 一个提供网络研究和发现功能的综合模型上下文协议（MCP）服务器，包含13种工具用于搜索、爬取和分析网络内容。
- [xby-skill/xby-vnstock](https://github.com/xby-skill/xby-vnstock) — 一个非官方的MCP服务器，提供访问越南股市数据的工具，包括实时和历史股票价格、公司财务数据、市场统计和基金信息等。
...
- [xby-skill/xby-toronto-open-data-server](https://github.com/xby-skill/xby-toronto-open-data-server) — 一个通过CKAN API直接访问多伦多开放数据的MCP服务器，支持智能数据集发现、灵活查询和CSV数据预览，专为LLM代理设计。
- [xby-skill/xby-todolist](https://github.com/xby-skill/xby-todolist) — 为大型语言模型和AI代理提供外部工作记忆和任务管理功能，支持复杂多步骤任务的可靠执行。
...
- [xby-skill/xby-structured-argumentation](https://github.com/xby-skill/xby-structured-argumentation) — 一组模型上下文协议服务器，为大型语言模型提供认知增强工具。
- [xby-skill/xby-speech-synthesis](https://github.com/xby-skill/xby-speech-synthesis)
- [xby-skill/xby-source-coop](https://github.com/xby-skill/xby-source-coop) — 一个用于发现和访问800TB+地理空间数据的MCP服务器，支持AI客户端通过JSON-RPC协议进行交互，提供智能搜索和高效数据访问功能。
- [xby-skill/xby-smoking-detection](https://github.com/xby-skill/xby-smoking-detection)
- [xby-skill/xby-smart-search](https://github.com/xby-skill/xby-smart-search) — Smart Search MCP 是一个专注于技术领域的智能搜索工具集，提供14个增强型搜索工具，覆盖国际和国内主流技术平台，具备智能URL生成、输入验证、高级搜索技巧等功能，适用于开发者快速查找技术文档、API参考、开源项目等。
- [xby-skill/xby-sequentialthinking](https://github.com/xby-skill/xby-sequentialthinking) — 一个实现顺序思维协议的MCP服务器，提供结构化的问题解决方法，将复杂问题分解为可管理的步骤，并支持迭代优化和替代推理路径。
...
- [xby-skill/xby-scan-code](https://github.com/xby-skill/xby-scan-code) — CodeGuard MCP是一款实时AI代码安全扫描工具，用于检测AI生成代码中的漏洞、密钥和合规性问题，适用于开发环境中的代码安全审查。
- [xby-skill/xby-running-formulas](https://github.com/xby-skill/xby-running-formulas) — 一个提供全面的跑步计算工具的MCP服务器，包括VDOT计算、训练配速、比赛时间预测、速度标记、心率区间和配速转换等功能。
...
- [xby-skill/xby-random-number](https://github.com/xby-skill/xby-random-number) — 提供伪随机和加密安全的随机数生成功能，包括整数、浮点数、加权选择、列表洗牌和安全令牌生成。
...
- [xby-skill/xby-qanon](https://github.com/xby-skill/xby-qanon) — 一个提供QAnon帖子数据集访问的MCP服务器，用于人类学和社会学研究，支持搜索、过滤和分析功能。
- [xby-skill/xby-pubchem](https://github.com/xby-skill/xby-pubchem) — 该服务通过PubChem API提取药物基础化学信息，包括分子式、分子量、CAS号等关键数据。
...
- [xby-skill/xby-open-data-hk](https://github.com/xby-skill/xby-open-data-hk) — 一个提供香港政府官方开放数据门户DATA.GOV.HK数据访问的MCP服务器，支持数据集列表、详情查询、分类检索及格式筛选等功能。
- [xby-skill/xby-ons-data](https://github.com/xby-skill/xby-ons-data) — 一个用于访问英国国家统计局(ONS) Beta API的模型上下文协议(MCP)服务器，无需API密钥即可获取官方统计数据。
...
- [xby-skill/xby-mm1-simulation](https://github.com/xby-skill/xby-mm1-simulation) — 一个用于M/M/1和M/M/c队列系统模拟和分析的Model Context Protocol服务器，提供全面的资源、工具和提示。
- [xby-skill/xby-mingli](https://github.com/xby-skill/xby-mingli)
- [xby-skill/xby-mermaid-doc](https://github.com/xby-skill/xby-mermaid-doc) — Mermaid Doc MCP Server是一个用于生成Mermaid文档的服务器，提供列出可用图表和检索特定图表文档的功能。
- [xby-skill/xby-medical-knowledge-graph](https://github.com/xby-skill/xby-medical-knowledge-graph)
- [xby-skill/xby-mbit-test](https://github.com/xby-skill/xby-mbit-test) — 一个用于MBTI人格测试的MCP服务器，支持AI助手引导用户完成人格测试并给出结果分析。
- [xby-skill/xby-mathematics](https://github.com/xby-skill/xby-mathematics)
- [xby-skill/xby-mathematical-visualization](https://github.com/xby-skill/xby-mathematical-visualization) — 基于JSXGraph的MCP协议服务器，提供13种数学可视化工具，适用于教育数学、工程和科学应用。
- [xby-skill/xby-math](https://github.com/xby-skill/xby-math) — 一个高性能的数学计算协议服务器，提供从基础算术到高级微积分和线性代数的全面数学计算功能。
...
- [xby-skill/xby-lunar-calendar](https://github.com/xby-skill/xby-lunar-calendar) — 一个基于Python 3.12和lunar-python的中国传统农历日历功能服务器，提供八字计算、日历转换、黄历查询等功能。
...
- [xby-skill/xby-hitoshura25-android-playstore-deploy](https://github.com/xby-skill/xby-hitoshura25-android-playstore-deploy) — 一个帮助开发者设置自动化Google Play商店部署流程的工具，支持项目分析、密钥生成、服务账户配置和GitHub Actions工作流生成。
...
- [xby-skill/xby-hackernews-search](https://github.com/xby-skill/xby-hackernews-search) — 一个通过Model Context Protocol提供HackerNews内容搜索、检索和分析的服务，适用于AI代理和开发者。
- [xby-skill/xby-gsap-animation-generate](https://github.com/xby-skill/xby-gsap-animation-generate)
- [xby-skill/xby-glama-registry](https://github.com/xby-skill/xby-glama-registry) — 提供MCP注册服务器的搜索功能，用于查询匹配特定字符串的MCP服务器。
...
- [xby-skill/xby-generate-echarts](https://github.com/xby-skill/xby-generate-echarts) — MCP ECharts 是一个基于 Apache ECharts 的动态图表生成和数据分析工具，支持多种导出格式和 MinIO 对象存储集成。
- [xby-skill/xby-general-recognition](https://github.com/xby-skill/xby-general-recognition)
- [xby-skill/xby-gathering-card-lookup-service](https://github.com/xby-skill/xby-gathering-card-lookup-service) — 一个基于Model Context Protocol (MCP)的服务端，提供万智牌中文卡牌信息的查询和搜索功能。
- [xby-skill/xby-fund-knowledge-query](https://github.com/xby-skill/xby-fund-knowledge-query)
- [xby-skill/xby-french-tax](https://github.com/xby-skill/xby-french-tax) — 一个提供法国个人所得税计算的MCP服务器，支持基于净应税收入和家庭构成的计算，并动态获取最新税档信息。
- [xby-skill/xby-fluent](https://github.com/xby-skill/xby-fluent) — 一个帮助AI助手高效导航ANSYS Fluent在线文档的模型上下文协议（MCP）服务器，提供智能URL导航、预映射主题路径和官方文档链接。
- [xby-skill/xby-fire-detection](https://github.com/xby-skill/xby-fire-detection)
- [xby-skill/xby-fetch](https://github.com/xby-skill/xby-fetch) — 一个模型上下文协议服务器，提供网页内容抓取功能，将HTML转换为Markdown以便于处理。适用于需要从网页提取和处理内容的场景。
- [xby-skill/xby-fastdomaincheck](https://github.com/xby-skill/xby-fastdomaincheck) — 一个基于Python和MCP协议的域名注册状态检查服务器，支持批量检查和双重验证。
- [xby-skill/xby-fantasynbaleague](https://github.com/xby-skill/xby-fantasynbaleague) — 一个为Fantasy NBA以色列联赛提供统计数据、排名和分析的MCP服务器。
- [xby-skill/xby-extract-image](https://github.com/xby-skill/xby-extract-image)
- [xby-skill/xby-extract-antv-topic](https://github.com/xby-skill/xby-extract-antv-topic) — 为AI开发和QA设计的模型上下文协议服务器，提供AntV文档上下文和代码示例。
- [xby-skill/xby-epub-template-server](https://github.com/xby-skill/xby-epub-template-server) — 智能模板发现助手 - 为 AI 应用提供强大的 epub360 模板搜索能力
...
- [xby-skill/xby-defi-yields](https://github.com/xby-skill/xby-defi-yields) — 一个为AI代理提供DeFi收益机会探索和分析的MCP服务器，支持从DefiLlama获取收益池数据并进行关键指标分析。
- [xby-skill/xby-ddg-search](https://github.com/xby-skill/xby-ddg-search) — 一个提供DuckDuckGo网络搜索能力并具备内容抓取和解析功能的模型上下文协议（MCP）服务器。
- [xby-skill/xby-dblp](https://github.com/xby-skill/xby-dblp) — 一个通过模型上下文协议（MCP）提供DBLP计算机科学文献数据库访问的服务，支持学术文献检索、引用生成及格式化功能。
- [xby-skill/xby-db](https://github.com/xby-skill/xby-db) — MCP Database Server 是一个为AI助手和基于LLM的工具提供安全数据库访问的服务，支持SQLite、PostgreSQL、MySQL和MariaDB，具有查询验证、审计日志和安全控制功能。
...
- [xby-skill/xby-daily-hot](https://github.com/xby-skill/xby-daily-hot) — 基于Model Context Protocol (MCP)协议的全网热点趋势一站式聚合服务，支持Python实现，适用于新闻资讯、社交媒体、科技开发等多领域。
- [xby-skill/xby-currency-and-oil](https://github.com/xby-skill/xby-currency-and-oil)
- [xby-skill/xby-csv2json](https://github.com/xby-skill/xby-csv2json) — 一个基于FastMCP的CSV到JSON转换MCP服务器，提供高效的CSV数据转换服务。
- [xby-skill/xby-cryptocurrency-data-api-service](https://github.com/xby-skill/xby-cryptocurrency-data-api-service) — DexPaprika MCP Server是一个提供实时加密货币和DEX数据访问的API服务，专为AI助手设计，无需配置即可获取代币、流动池和DEX数据。
- [xby-skill/xby-cpan-package-info](https://github.com/xby-skill/xby-cpan-package-info)
- [xby-skill/xby-cookie-reward](https://github.com/xby-skill/xby-cookie-reward) — 一个通过游戏化自我反思为LLM提供Cookie奖励的模型上下文协议服务器。
- [xby-skill/xby-constellation](https://github.com/xby-skill/xby-constellation)
- [xby-skill/xby-code-document-update](https://github.com/xby-skill/xby-code-document-update) — Context7 MCP 是一款为开发者提供最新代码文档和示例的服务，通过集成到开发环境中，确保LLM生成的代码基于最新的库文档。
...
- [xby-skill/xby-celo-composer-kit](https://github.com/xby-skill/xby-celo-composer-kit) — Celo MCP Server 是一个用于安装和配置 Celo Composer Kit MCP 服务器的工具，支持在 macOS 上运行，提供组件发现、集成和示例功能。
- [xby-skill/xby-cellphone-detection](https://github.com/xby-skill/xby-cellphone-detection)
- [xby-skill/xby-cellosaurus](https://github.com/xby-skill/xby-cellosaurus) — Cellosaurus MCP Server是一个非官方的模型上下文协议服务器，用于访问SIB Cellosaurus细胞系知识资源，提供细胞系搜索、详细信息获取和数据库版本信息等功能。
- [xby-skill/xby-ccxt](https://github.com/xby-skill/xby-ccxt) — 一款通过自然语言交互追踪每日卡路里摄入量的MCP服务器，提供餐食记录、每日总结、周报生成和食物搜索功能。
- [xby-skill/xby-captcha](https://github.com/xby-skill/xby-captcha)
- [xby-skill/xby-caltrain](https://github.com/xby-skill/xby-caltrain) — 基于GTFS数据的Caltrain火车时刻查询服务，提供实时火车时刻表、站点查询和时间特定查询功能。
- [xby-skill/xby-calculator](https://github.com/xby-skill/xby-calculator)
- [xby-skill/xby-calculator-kel](https://github.com/xby-skill/xby-calculator-kel) — 基于Model Context Protocol (MCP)的数值计算器，提供加减乘除、幂运算、平方根和整数阶乘运算功能。
- [xby-skill/xby-blockchain-data-service](https://github.com/xby-skill/xby-blockchain-data-service) — Vitruveo MCP Server 是一个为 Vitruveo 网络提供只读区块链服务的模型上下文协议服务器，适用于AI代理访问区块链数据。
- [xby-skill/xby-bird](https://github.com/xby-skill/xby-bird)
- [xby-skill/xby-biomarker-ranges](https://github.com/xby-skill/xby-biomarker-ranges) — 基于Morgan Levine PhenoAge时钟模型，通过血液生物标志物计算生物年龄的服务。
- [xby-skill/xby-bilibili](https://github.com/xby-skill/xby-bilibili) — 用于哔哩哔哩API的MCP服务器，支持视频搜索、用户内容获取等多种操作，适用于哔哩哔哩内容管理和数据分析场景。
- [xby-skill/xby-bilibili-video-info](https://github.com/xby-skill/xby-bilibili-video-info) — 一个用于从Bilibili视频URL中检索字幕、弹幕和评论信息的MCP服务器。
- [xby-skill/xby-bilibili-api](https://github.com/xby-skill/xby-bilibili-api) — 一个为bilibili.com API提供服务的Model Context Protocol (MCP)服务器，支持获取用户信息、视频搜索等功能。
- [xby-skill/xby-berlin-search-services](https://github.com/xby-skill/xby-berlin-search-services)
- [xby-skill/xby-bbot](https://github.com/xby-skill/xby-bbot) — BBOT MCP服务器是一个用于管理和执行BBOT安全扫描的工具，提供模块管理、预设配置、实时监控等功能。
- [xby-skill/xby-bazi](https://github.com/xby-skill/xby-bazi)
- [xby-skill/xby-awslabs-cdk](https://github.com/xby-skill/xby-awslabs-cdk) — AWS CDK MCP Server是一个提供AWS Cloud Development Kit (CDK)最佳实践、基础设施即代码模式和CDK Nag安全合规性的工具，适用于开发者在构建AWS应用程序时获取指导和建议。
- [xby-skill/xby-awslabs-aws-diagram](https://github.com/xby-skill/xby-awslabs-aws-diagram) — 通过Amazon Q CLI和MCP服务器在GitHub Codespace中快速生成高质量的AWS架构图。
- [xby-skill/xby-aws-blackbelt](https://github.com/xby-skill/xby-aws-blackbelt) — 一个提供 AWS Black Belt 在线研讨会搜索功能的模型上下文协议（MCP）服务器，支持通过关键词搜索研讨会内容并获取研讨会视频的文字记录。
- [xby-skill/xby-atlas-docs](https://github.com/xby-skill/xby-atlas-docs) — Atlas Docs MCP服务器为AI助手提供库和框架的技术文档，将官方文档处理为适合LLM使用的Markdown版本，适用于Cursor、Cline、Windsurf等MCP兼容的LLM客户端。
...
- [xby-skill/xby-arxiv-paper-search](https://github.com/xby-skill/xby-arxiv-paper-search) — 一个基于arXiv的论文检索与内容解析工具，支持论文搜索、PDF链接获取和内容解析功能，适用于学术研究和AI领域的最新论文获取。
- [xby-skill/xby-article](https://github.com/xby-skill/xby-article) — 基于FastMCP框架开发的专业文献搜索工具，支持多源文献搜索、文献详情获取、参考文献管理、文献关系分析、期刊质量评估和批量结果导出等功能，适用于学术研究和AI助手集成。
- [xby-skill/xby-anndata](https://github.com/xby-skill/xby-anndata) — AnnData MCP是一个通过MCP协议检索AnnData对象信息的工具，适用于生物医学数据分析场景。
...
- [xby-skill/xby-akshare](https://github.com/xby-skill/xby-akshare) — AKShare MCP Server 是一个通过AKShare提供中国股票市场数据的模型上下文协议服务器，支持实时行情、历史数据、基本面分析等功能。
- [xby-skill/xby-akshare-one](https://github.com/xby-skill/xby-akshare-one) — 基于akshare-one的MCP服务器，提供中国股票市场数据的全面接口，包括历史数据、实时数据、新闻数据和财务报表等金融信息。
...
- [morluto/flameox](https://github.com/morluto/flameox) ⭐121 — Runtime evidence that helps agents trace, profile, and burn down hotspots in application and native code, GPU kernels, and inference stacks.
...
- [morluto/rea](https://github.com/morluto/rea) ⭐400 — Reverse engineer anything with agents, from app behavior down to native binaries.
- [saqie803/ponytail](https://github.com/saqie803/ponytail) ⭐1 — Ship production-ready code with one line of AI-generated output, built for 20 agents and zero ceremony.
...
- [Unclecheng-li/AI_Animation](https://github.com/Unclecheng-li/AI_Animation) ⭐1301 — 本项目整理了用于生成[炫酷 HTML 动画网页]的 AI Prompts，涵盖动画效果、3D 可视化、PPT 风格演示、UI 美化等多个类别。
...
- [fangqian616/consensus-pipeline](https://github.com/fangqian616/consensus-pipeline) ⭐121 — Multi-agent department framework for long-form complex tasks, fighting AI hallucination, validated on academic research. 共识管线：多智能体部门长线任务解决框架，对抗AI幻觉，以学术研究为验证场景。
...
- [wecode-ai/Wegent](https://github.com/wecode-ai/Wegent) ⭐854 — Plan, build, and deliver with an open-source, self-hostable AI workspace for coding, collaboration, and automation.
...
- [Justin-sky/ai-art-engine](https://github.com/Justin-sky/ai-art-engine) ⭐134 — AI 艺术创作引擎，专业的短视频，游戏3D资产，2D资产，广告创作工具
...
- [huangruiteng/loopx](https://github.com/huangruiteng/loopx) ⭐5877 — Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.
...
- [SilenZerOrz/obsidian-dsh-acp](https://github.com/SilenZerOrz/obsidian-dsh-acp) ⭐1
...
- [Practice019/desktop-taste-skills](https://github.com/Practice019/desktop-taste-skills)
- [tnnevol/fn-os-apps](https://github.com/tnnevol/fn-os-apps) ⭐38 — 飞牛 fnOS 应用 Monorepo
- [lovaxi/Rubato_Device](https://github.com/lovaxi/Rubato_Device) ⭐1 — Rubato - a palm-sized retro-Macintosh AI desk companion that turns AI wait time into gentle health breaks. Firmware, tools and docs.
- [ian00005/you-know-nothing](https://github.com/ian00005/you-know-nothing)
- [npxcnency-ux/pi-trace-extension](https://github.com/npxcnency-ux/pi-trace-extension) ⭐16 — Langfuse-style trace viewer for pi-agent — local-first, zero-setup, single-file HTML
- [lovaxi/Rubato_Plugins](https://github.com/lovaxi/Rubato_Plugins) ⭐2 — Make your AI's working state visible on a physical desk device - one Rubato plugin per coding agent.
- [Andiii208/gzhflow](https://github.com/Andiii208/gzhflow) ⭐2 — 跨 Agent 公众号内容发布工作流框架 — 素材先行/写作/去AI味/配图/排版/推草稿箱 六阶段流水线，适配 Claude Code/Cursor/Codex/Gemini/Qwen/DeepSeek 等主流 Agent
...
- [nomicore-ai/nomicore](https://github.com/nomicore-ai/nomicore) ⭐3 — A self-describing, governed data core for AI agents—schemas, authority, validation, and semantic context travel with the data.
- [Liyuan1992/rawmem](https://github.com/Liyuan1992/rawmem) ⭐1 — A tiny local-first raw evidence ledger for AI and human workflows.
...
- [plastic-labs/honcho](https://github.com/plastic-labs/honcho) ⭐7212 — Memory library for building stateful agents
- [x5427876/dsh-claude-subscription](https://github.com/x5427876/dsh-claude-subscription)
- [huaweicloud/huaweicloud-devkit](https://github.com/huaweicloud/huaweicloud-devkit) ⭐49 — Official Huawei Cloud plugin for AI agents — skills, MCP tools, safety guardrails, and cloud sandbox to help AI agents build, deploy, and operate on Huawei Cloud securely.
- [BHXiang/auto-pwa](https://github.com/BHXiang/auto-pwa) ⭐2 — AI驱动的分波分析自动化。
- [ZhongRuiYu-mine/math-modeling-plugin](https://github.com/ZhongRuiYu-mine/math-modeling-plugin)
- [bbaz123/novel-writing-plugin](https://github.com/bbaz123/novel-writing-plugin)
- [Kihara777/NixKits](https://github.com/Kihara777/NixKits) ⭐26 — 软件、补丁、NixOS 模块与 AI 编码助手的技能合集。
...
- [inclusionAI/Avernet](https://github.com/inclusionAI/Avernet) ⭐555 — Distributed agent coordination platform where agents live, connect, coordinate, execute, and evolve together.
...
- [iamaanahmad/everything-kiro](https://github.com/iamaanahmad/everything-kiro) ⭐28 — The complete collection of Kiro IDE configs, agents, skills, hooks, and MCP integrations for maximum productivity.
- [LodyAI/acp-extension-dsh](https://github.com/LodyAI/acp-extension-dsh)
- [Hoshino-Yumetsuki/as-compatible-copilot](https://github.com/Hoshino-Yumetsuki/as-compatible-copilot) — A VSCode extension to use Openai/Anthropic/Gemini API Providers in GitHub Copilot Chat
- [liangyou09/lyshell](https://github.com/liangyou09/lyshell) ⭐2 — AI-native terminal & SSH client — Harness launches DeepSeek / CodEx / Claude agents on PowerShell 7 in TUI or embedded Web UI, plus SFTP, serial/Telnet and a built-in MCP server.
...
- [chenxiachan/thoughtdag](https://github.com/chenxiachan/thoughtdag) ⭐464 — Your thinking deserves a map: an infinite canvas where LLM conversations grow into an editable thought graph. Wires are the context.
...
- [januory/deepseek-harness-gateway](https://github.com/januory/deepseek-harness-gateway) ⭐2
- [dsboylw/LazyNoobsCockloft](https://github.com/dsboylw/LazyNoobsCockloft) ⭐1 — Lazy Noob's Cockloft
- [cmyfqwq/webauthn-for-webview-shells](https://github.com/cmyfqwq/webauthn-for-webview-shells) — Enable passkeys in WebView-shell browsers (Via, Quark, ...) via the official androidx.webkit switch — LSPosed module; targets older WebView (~124-13x) where WebAuthn is not default-enabled; fully reversible
- [pakgrou-porg/yardmaster](https://github.com/pakgrou-porg/yardmaster) — Two-stage LLM router: Switchyard model selection + PAIR node placement, one local endpoint
- [opqnext/moji-docs](https://github.com/opqnext/moji-docs) ⭐6 — MojiDocs 是一款跨平台的 Markdown Wiki 桌面应用，基于 Electron + Vue 3 + SQLite 构建。
- [busabase/busabase-dsh-plugin](https://github.com/busabase/busabase-dsh-plugin) ⭐5
- [ffseika0304/code-ownership-audit](https://github.com/ffseika0304/code-ownership-audit) — 判定 Python 代码是原创还是演绎作品 — 纯本地 AST 分析，零依赖不联网。Agent Skill，任何智能体可用。Detect derivative work in Python code, offline & dependency-free.
- [bug-huntter/web-search-advanced](https://github.com/bug-huntter/web-search-advanced)
- [helllo-shijie/motor-hospital-plugins](https://github.com/helllo-shijie/motor-hospital-plugins)
- [yeyuan98/bioresearcher-skills](https://github.com/yeyuan98/bioresearcher-skills) ⭐1 — Agent Skills/Plugins/Connectors for biomedical research with the biomcp-ts MCP server.
- [sanqiPanax/jieyaTool](https://github.com/sanqiPanax/jieyaTool)
- [sidleo/llm-wiki](https://github.com/sidleo/llm-wiki) ⭐1
- [gwj001/arch-lens](https://github.com/gwj001/arch-lens) ⭐3 — 一个基于代码事实的，ai画图、ai 讲解的代码架构学习台插件(An AI drawing and AI explanation code architecture learning platform plugin)
- [limochaishang/crash-guard-dsh](https://github.com/limochaishang/crash-guard-dsh) ⭐1
- [Krypton-117/AsYouMeant](https://github.com/Krypton-117/AsYouMeant) ⭐2
- [SiriusNEO/StarAgent](https://github.com/SiriusNEO/StarAgent) ⭐59 — Lightweight agent multiplexer, all in one Web dashboard
...
- [Ayuilos/Miffan](https://github.com/Ayuilos/Miffan) ⭐115 — RikkaHub fork，Android AI 客户端。支持 ChatGPT 订阅登录使用、跨应用划词悬浮翻译、助手工作区文件隔离、工作区 Skills 自动发现、文档与 HTML 预览、可定制动态角色。
...
- [xby-skill/xby-detect-fake](https://github.com/xby-skill/xby-detect-fake) — 对图片进行真伪鉴别的综合检测能力：识别图片是否为人工智能生成，或是否被人为编辑、篡改。适用于需要核验图片真实性的场景，例如网络图片溯源核验、媒体内容审核、可疑图片初筛等。返回整体伪造概率 score（0~1，越接近 1 越可能为伪造，score>0.5 判定为伪造）及是否伪造标识 isFake。
- [xby-skill/xby-detect-fake-face](https://github.com/xby-skill/xby-detect-fake-face) — 针对人脸图片的真伪鉴伪能力：识别图片是否为人工智能生成，或人脸区域是否被深度伪造 / AI 换脸篡改。适用于需要核验人像真实性的场景，例如证照人脸审核、视频通话与直播的人像核验、肖像与版权人脸核验等。本能力专注人脸真伪鉴定，不检测图像中非人脸区域的复制—移动、拼接等局部篡改（这类图片请使用通用图片鉴伪能力）。返回整体伪造概率 score（0~1，越接近 1 越可能为伪造，score>0.5 判定为伪造）及是否伪造标识 isFake。
- [xby-skill/xby-detect-fake-certificate](https://github.com/xby-skill/xby-detect-fake-certificate) — 针对证件的图片鉴伪能力：识别证件图片是否为人工智能生成，或其证件内容区域是否被人工编辑、篡改（如改字、抠贴拼接等）。适用于各类身份、证照类图片的真实性核验场景，例如证件照审核、证照上传审查、身份核验与风控等。返回整体伪造概率 score（0~1，越接近 1 越可能为伪造，score>0.5 判定为伪造）及是否伪造标识 isFake。
- [xby-skill/xby-detect-aigc](https://github.com/xby-skill/xby-detect-aigc) — 识别输入图片是否由人工智能（AIGC）直接生成，例如使用文生图/图生图类工具产出的合成图片。适用于需要甄别图片是否属于 AI 合成产物的场景，例如平台内容治理中的AI 内容标识、广告与新闻图片的真实来源核验、版权与合规筛查等。返回整体 AI 生成概率 score（0~1，越接近 1 越可能为 AI 生成，score>0.5 判定为 AI 生成）及是否为AI 生成标识 isFake。本能力不检测人为编辑、篡改或拼接的图片（这类图请使用通用鉴伪或证件鉴伪能力）。
- [jigjoy-ai/baro](https://github.com/jigjoy-ai/baro) ⭐121 — A CLI that turns a goal into a pull request - and a sandbox for testing concurrent AI coding agents on the Mozaik runtime.
...
- [Cosmicwanderer1/lean4-harness-plugin](https://github.com/Cosmicwanderer1/lean4-harness-plugin) ⭐1
- [acryldev/pi-cordis](https://github.com/acryldev/pi-cordis) — pi-cordis
- [weekitmo/oh-my-dsh-plugins](https://github.com/weekitmo/oh-my-dsh-plugins)
- [ljzRober/L-clone](https://github.com/ljzRober/L-clone) ⭐2 — 一个分层记忆 + 回顾环 + 规范环的个人外置大脑:记录你做过什么,并在你 规划未来时调用记忆、监督方案的边界条件。
- [Practice019/agent-skills](https://github.com/Practice019/agent-skills)
- [ffseika0304/code-ownership-audit-java](https://github.com/ffseika0304/code-ownership-audit-java) — Java 版代码所有权体检：判定 Java 代码是原创还是演绎作品。纯本地 JavaParser AST 分析，依赖烤进 audit.jar，零装包、不联网、不调模型。
- [NokorinNishikino/Kidai-Clipboard](https://github.com/NokorinNishikino/Kidai-Clipboard) ⭐1 — Kidai-ClipBoard (纪代剪贴板, KCB)  跨会话剪贴板 + 会话预设：随时保存并回填内容，可把会话截断作为分支预设；右侧停靠侧栏 + 可编辑文件夹树+ 标签体系，条目支持拖拽归类与排序，收起胶囊可拖动定位、拖离边缘即变悬浮窗，操作按钮与缩放把手可移到左侧竖栏以避开其它插件浮层。
- [120777190/dsh_plugin](https://github.com/120777190/dsh_plugin) — 用Harmess搞的自用插件合集
- [toustifer/agentflow](https://github.com/toustifer/agentflow) ⭐3 — Lightweight task state machine engine with MCP stdio interface
- [youli42/dsh_BetterInput](https://github.com/youli42/dsh_BetterInput)
- [2286893544/feishu-dsh-plugin](https://github.com/2286893544/feishu-dsh-plugin)
- [wswbx/quick-research-campaign](https://github.com/wswbx/quick-research-campaign)
- [dreamor/MemVault](https://github.com/dreamor/MemVault) — MemVault — The Shared Memory Layer for Every AI Agent You Run. MCP-native memory router with auto-injection, hybrid search, and zero-config sync.
- [zzjzzb/ai-memory](https://github.com/zzjzzb/ai-memory) ⭐3 — Personal AI memory semantic layer SDK (Rust + SQLite) — short/mid/long-term memory with hybrid recall
- [greyoak111/siyuan-codex-bridge](https://github.com/greyoak111/siyuan-codex-bridge) — Local Codex and SiYuan official MCP bridge with the Siyuan Notes plugin tooling.
- [blueperformer/make-dsh-voice](https://github.com/blueperformer/make-dsh-voice) — A small plugin I made myself, inspired in part by other people's projects.
...
- [axelfreeman/hermes-security-audit](https://github.com/axelfreeman/hermes-security-audit) ⭐1 — 🔒 12-method security audit for Hermes Agent — virus scan, rootkit detection, SSH brute force protection
- [axelfreeman/backupper](https://github.com/axelfreeman/backupper) — Free encrypted deduplicated backups of remote Linux servers, pulled from a Windows PC with Restic — zero software installed server-side. AI-agent skill.
- [axelfreeman/marketing-mindset](https://github.com/axelfreeman/marketing-mindset) ⭐31 — The marketing OS for AI agents — a free MIT skill that teaches how a marketer decides: 3-month horizon, fast tests, minimum test volumes, scale what comes easy.
- [RempleXI/word-docx-writer](https://github.com/RempleXI/word-docx-writer) — 生成与排版中文 Word（.docx）的 Agent Skill 与工具包：标题使用 Word 内置样式，中文宋体 + 西文 Times New Roman，正文小四首行缩进，图表题注按章自动编号；通用于实验报告、课程设计报告、毕业论文等各类中文长文档。
- [xichow0663-gif/yt-research-skill](https://github.com/xichow0663-gif/yt-research-skill) — An agent skill that batch-researches a YouTube channel's latest N videos — captions first, local ASR fallback — and writes one cross-video report instead of N summaries. Works in DSH, Codex, Claude Code, Hermes and WorkBuddy.
- [Z-Asset/ZA_analysis](https://github.com/Z-Asset/ZA_analysis) — ZA Research analysis stage — end-to-end model training and estimation for asset pricing + ML/DL research.
- [Z-Asset/ZA_ppt](https://github.com/Z-Asset/ZA_ppt) — ZA Research PPT stage — presentation generation (Beamer/Quarto) from the paper.
- [Z-Asset/ZA_report](https://github.com/Z-Asset/ZA_report) — ZA Research report stage — academic paper writing for asset pricing + ML/DL research.
- [Z-Asset/ZA_data](https://github.com/Z-Asset/ZA_data) — ZA Research data stage — data discovery and quality assessment for asset pricing + ML/DL research.
- [Z-Asset/ZA_literature](https://github.com/Z-Asset/ZA_literature) — ZA Research literature stage — search, synthesis, and citation-chain tracking for asset pricing + ML/DL research.
- [andrepontesmelo/deep-horizon](https://github.com/andrepontesmelo/deep-horizon) — Deep Horizon is a set an AI plugin for injecting long term goals
- [RubyCcll/create-dsh-bundle](https://github.com/RubyCcll/create-dsh-bundle)
- [AkinoHaruka/companion-memory](https://github.com/AkinoHaruka/companion-memory) — 面向 AI 伴侣的长期记忆：受治理的准入、提及闸门与结构化边界保护
- [ToryReina/deepseek-vision](https://github.com/ToryReina/deepseek-vision)
...
- [agentrq/agentrq](https://github.com/agentrq/agentrq) ⭐1121 — AgentRQ: Human-in-loop realtime conversational task manager for AI Agents. Self-hosted! Control your own agents from wherever you want Mobile, Web, Desktop. Designed to work well with your own Claude subscriptions and any harness with ACP support.
...
- [nocobase/nocobase](https://github.com/nocobase/nocobase) ⭐24251 — NocoBase is an open-source AI + no-code platform for building business systems fast. Instead of generating everything from scratch, AI works on top of production-proven infrastructure and a WYSIWYG no-code interface, so you get both speed and reliability.
...
- [opencues/opencues](https://github.com/opencues/opencues) ⭐48 — The open standard for omnipresent AI. Claude Code, OpenCode, Gemini CLI, Shell, Chrome, DeepSeek Harness. Model-agnostic
...
- [ChenneyZhuang/resume-localize-cn2en](https://github.com/ChenneyZhuang/resume-localize-cn2en) — Resume localization skill (CN to EN): demographic fields stripped, duties become quantified outcomes, one spelling variant, ATS-parsable, full change log. CN/EN.
- [ChenneyZhuang/competitor-recon](https://github.com/ChenneyZhuang/competitor-recon) — Competitor research skill: complaint-driven recon with cited evidence from reviews, forums, and issue trackers — comparison table plus copy-worthy and skip lists. CN/EN.
- [ChenneyZhuang/email-deliverability-audit](https://github.com/ChenneyZhuang/email-deliverability-audit) — Email deliverability audit skill: four sequential DNS gates classify addresses as sendable/risky/dead — every verdict traces to a query run that session. CN/EN.
- [liyixuan201211/mcp-cap](https://github.com/liyixuan201211/mcp-cap) ⭐1 — What can this MCP server actually do — and has it changed since you trusted it? Inspect its declared capabilities, seal them in a lock file, and get told when a later version can do more. Never invokes a tool; gives the server a minimal environment.
- [chenqg618/compliance-skills](https://github.com/chenqg618/compliance-skills) — 150+ deterministic, fully-offline MCP tools & free AI-agent skills for cross-industry monthly checks (payroll, tax, invoicing, reconciliation, inventory, tendering, freight, property, medical consumables): every finding quotes the source line, no model, no network, recomputable. 各行业每月必做的机械核对工具集：MCP 工具 150+ 与免费 AI 技能，纯离线、结论可复算。
- [guannan1031/yanxu-dsh-plugin](https://github.com/guannan1031/yanxu-dsh-plugin)
- [xby-skill/xby-wav](https://github.com/xby-skill/xby-wav) — 音频文件转WAV格式。
- [xby-skill/xby-tts-cn](https://github.com/xby-skill/xby-tts-cn) — 中文文字转语音。
- [xby-skill/xby-punctuation](https://github.com/xby-skill/xby-punctuation) — 为文本添加标点符号。通过语音转文本从语音获取的文本，经常不包含标点符号，可以使用此功能。
- [xby-skill/xby-mp3](https://github.com/xby-skill/xby-mp3) — 音频文件转MP3格式。
...
- [dshbox/cordis-rs](https://github.com/dshbox/cordis-rs) ⭐50 — A typed runtime for long-lived, plugin-oriented Rust applications — lifecycle, exact service placement, typed events, deterministic cleanup, scopes, and isolation.
- [ZSeven-W/rish-app](https://github.com/ZSeven-W/rish-app) ⭐124 — Your pocket agent. Local-first AI agents on iOS and Android — real workspaces, tool execution with approvals, and your choice of model (DSH · Claude Code · Codex · GLM).
...
- [ChenneyZhuang/verify-claims](https://github.com/ChenneyZhuang/verify-claims)
- [openguardrails/openguardrails](https://github.com/openguardrails/openguardrails) ⭐45 — The vendor-neutral protocol for AI agent safety & security — and the neutral benchmark that ranks the vendors.
- [ChenneyZhuang/context-budget](https://github.com/ChenneyZhuang/context-budget) — Context budget skill: graduated file reads (head, section, search), a working notes file that survives compaction, and three-line checkpoints at phase boundaries — long tasks finish on notes, not fumes.
- [ChenneyZhuang/template-instantiator](https://github.com/ChenneyZhuang/template-instantiator) — Template instantiator skill: inventory every placeholder and example block, fill from stated data inventing nothing, delete unrequested optional sections, and show the zero-hit residue scan with the delivery.
- [ChenneyZhuang/changelog-capture](https://github.com/ChenneyZhuang/changelog-capture) — Changelog capture skill: user-facing entries at change time in who/what/upgrade shape, Added/Changed/Fixed with breaking changes leading, verified against the actual diff at release.
- [ChenneyZhuang/estimate-before-build](https://github.com/ChenneyZhuang/estimate-before-build) — Estimate-before-build skill: bounded task list, S/M/L/XL band estimates with uncertainty drivers named, scope-vs-budget options surfaced to the user, and estimates recorded for finish-line calibration.
- [ChenneyZhuang/ask-batch](https://github.com/ChenneyZhuang/ask-batch) — Ask-batch skill: park piecemeal questions with context, group by decision, ask once per group with proposed defaults in a numbered format, and apply defaults visibly — true blockers still ask immediately.
- [ChenneyZhuang/weekly-review](https://github.com/ChenneyZhuang/weekly-review) — Weekly review skill: reconcile last week's logged commitments against outcomes with evidence, bank wins, carry items forward only with a fresh reason, and commit to a small checkable set — logged for next week to compare.
- [ChenneyZhuang/expense-capture](https://github.com/ChenneyZhuang/expense-capture) — Expense capture skill: receipts to ledger-ready rows without invention — transcribe as shown, flag unclear fields, read tax never derive it, and reconcile count and total before any write.
...
- [wei125775-lab/whalegirl-deskpet](https://github.com/wei125775-lab/whalegirl-deskpet) ⭐1 — 会跟着 Claude Code 干活的鲸鱼娘桌宠（PetPet / dsh 双版本，Windows · macOS）。干活时她端碗吃饭，收工收碗，按 Esc 打断会甩你一个屑表情。A desktop pet that reacts to your Claude Code session.
- [yixiuzhemu/MCP-Manager](https://github.com/yixiuzhemu/MCP-Manager) — MCP-Server管理
- [SepineTam/cnki-mcp](https://github.com/SepineTam/cnki-mcp) ⭐32 — An MCP server for reach CNKI.
...
- [acryldev/acryl](https://github.com/acryldev/acryl) ⭐240 — ACRYL - Agent Context Relay Yielding Lifecycles. One persistent workspace, one canonical context, any coding agent.
- [avdergh/poe2-exile-architect](https://github.com/avdergh/poe2-exile-architect) — Research, create, and understand Path of Exile 2 builds with AI agents and Path of Building.
...
- [Crash0524/Timeseries-Workbench-DSH](https://github.com/Crash0524/Timeseries-Workbench-DSH) — 为时序工作者提供的时序工作台
- [youdotcom-oss/agent-skills](https://github.com/youdotcom-oss/agent-skills) ⭐73 — You.com skills and plugins for web search, content extraction, research, finance, and integration discovery, helping AI agents build with up-to-date web context.
...
- [fengshuai3/memosbox-dsh-plugin](https://github.com/fengshuai3/memosbox-dsh-plugin)
- [RCYD857/857-dsh-pdf-patched](https://github.com/RCYD857/857-dsh-pdf-patched)
- [PPawnsir/task-board-plugin](https://github.com/PPawnsir/task-board-plugin) ⭐4
- [RCYD857/857-dsh-file-attach](https://github.com/RCYD857/857-dsh-file-attach)
- [sudoun/memo_harness](https://github.com/sudoun/memo_harness) ⭐1 — Agent memory with error bars: full local posteriors reconciled under finite relation laws. Dedupes source lineage, corrects without rewriting history. One CLI + SQLite.
...
*Generated on 2026-09-17 · 964 plugins in this category*
