...
- [xing-shuyin/pi-web-ui](https://github.com/xing-shuyin/pi-web-ui) ⭐227 — Just open your browser — get all your work done.
...
- [Innocent-children/dev-flow](https://github.com/Innocent-children/dev-flow) ⭐11 — Task control for AI coding agents: explicit scope, bounded verification, durable state, safe recovery. Codex · Claude Code · DeepSeek · ZCode.
...
- [sandbaseai/sandbase-harness](https://github.com/sandbaseai/sandbase-harness) ⭐650 — Local-first, self-hosted AI agent runtime and MCP bridge with sandboxed sessions, memory, credentials, audit/replay, and a local Console.
...
- [pulseaiclub/phi](https://github.com/pulseaiclub/phi) ⭐497 — a coding agent, rpc plugin, sub-agents, hashline edits, and mcp
...
- [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) ⭐6003 — The world's first open-source AI-native vector design tool and the first to feature concurrent Agent Teams. Design-as-Code. Turn prompts into UI directly on the live canvas. A modern alternative to Pencil.
...
- [volcengine/OpenViking](https://github.com/volcengine/OpenViking) ⭐38430 — Self-evolving Context Database for AI Agents. Unify Agent Memory, Knowledge RAG and Skills.
...
- [superdesigndev/treg](https://github.com/superdesigndev/treg) ⭐2060 — OpenRouter for agent tools. Join community here: https://discord.gg/6mQYYfFMAn
- [Leslie-SSS/seeWxapkg](https://github.com/Leslie-SSS/seeWxapkg) ⭐103 — 极简实用的微信小程序反编译 Web 工具
- [AtlasCloudAI/mcp-server](https://github.com/AtlasCloudAI/mcp-server) ⭐10 — MCP server for Atlas Cloud - AI API aggregation platform for image/video generation and LLM
...
- [reactive-resume/reactive-resume](https://github.com/reactive-resume/reactive-resume) ⭐43318 — A one-of-a-kind resume builder that keeps your privacy in mind. Completely secure, customizable, portable, open-source and free forever. Try it out today!
...
- [hashgraph-online/hol-guard](https://github.com/hashgraph-online/hol-guard) ⭐650 — Open-source antivirus for AI agents: block risky tools, secret access, prompt injection, malicious packages, MCP servers, plugins, and skills at runtime.
...
- [PicGo/PicGo-Core](https://github.com/PicGo/PicGo-Core) ⭐988 — :zap:The ultimate image uploading engine. Both CLI & API supports.
- [xiaods/k8e](https://github.com/xiaods/k8e) ⭐497 — k8e.sh - OpenSource Agentic AI Sandbox Matrix
...
- [tt-a1i/archify](https://github.com/tt-a1i/archify) ⭐69707 — Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flow, and lifecycle diagrams—self-contained HTML with motion and crisp export.
...
- [Tencent/BrowserSkill](https://github.com/Tencent/BrowserSkill) ⭐6544 — Let AI agents use your real, logged-in browser without interrupting your work. CLI + extension for browser automation across any shell-capable AI agent.
...
- [agentic-os-org/ANOLISA](https://github.com/agentic-os-org/ANOLISA) ⭐643 — ANOLISA (Agentic Nexus Operating Layer & Interface System Architecture) | Agentic OS with runtime, security, observability, and Tokenless response compression for lower token usage and cost.
...
- [OpenPetsHQ/openpets](https://github.com/OpenPetsHQ/openpets) ⭐1224 — Local first, desktop companion platform with animated pets, plugin SDK and coding-agent integrations.
...
- [tong-io/tongflow](https://github.com/tong-io/tongflow) ⭐1026 — Modality-First GenAI Platform
- [titanwings/distilly](https://github.com/titanwings/distilly) ⭐24964 — Distilly — Distill how they think into reusable Skills for any Agent or Bot. Formerly Colleague Skill（原同事 Skill）.
...
- [houyanchao/chatgpt-gemini-timeline](https://github.com/houyanchao/chatgpt-gemini-timeline) ⭐448 — ChatGPT & Gemini：Add Folders, Timeline & Prompts. - 为 ChatGPT & Gemini 添加文件夹、提示词库和时间轴。
...
- [Tencent/WeKnora](https://github.com/Tencent/WeKnora) ⭐28864 — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki.
...
- [ruvnet/ruflo](https://github.com/ruvnet/ruflo) ⭐73058 — 🌊 The original agent harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, federation, vector RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
...
- [xi-zhao/OpenQuantum](https://github.com/xi-zhao/OpenQuantum) ⭐65 — Open-source quantum Agent workspace with a desktop client, Web UI, messaging, Qiskit/MCP tools, and scientific validation
...
- [FrankHu-HK/mnemosyne](https://github.com/FrankHu-HK/mnemosyne) ⭐37 — Mnemosyne OS 7.0.2 — zero-dependency, local-first AI memory system (MCP / API / CLI / Python). MIT.
...
- [zilliztech/memsearch](https://github.com/zilliztech/memsearch) ⭐2635 — A persistent, unified memory layer for all your AI agents (e.g. Claude Code, Codex, DSH), backed by Markdown and Milvus.
...
- [loopx-project/loopx](https://github.com/loopx-project/loopx) ⭐5923 — Long-horizon agent control plane for durable, governed work across Codex, Claude Code, and other harnesses.
...
- [plastic-labs/honcho](https://github.com/plastic-labs/honcho) ⭐7298 — Memory library for building stateful agents
...
- [inclusionAI/Avernet](https://github.com/inclusionAI/Avernet) ⭐562 — Distributed agent coordination platform where agents live, connect, coordinate, execute, and evolve together.
...
- [toustifer/agentflow](https://github.com/toustifer/agentflow) ⭐4 — Lightweight task state machine engine with MCP stdio interface
...
- [agentrq/agentrq](https://github.com/agentrq/agentrq) ⭐1125 — AgentRQ: Human-in-loop realtime conversational task manager for AI Agents. Self-hosted! Control your own agents from wherever you want Mobile, Web, Desktop. Designed to work well with your own Claude subscriptions and any harness with ACP support.
...
- [nocobase/nocobase](https://github.com/nocobase/nocobase) ⭐24313 — NocoBase is an open-source AI + no-code platform for building business systems fast. Instead of generating everything from scratch, AI works on top of production-proven infrastructure and a WYSIWYG no-code interface, so you get both speed and reliability.
...
- [ZSeven-W/rish-app](https://github.com/ZSeven-W/rish-app) ⭐144 — Your pocket agent. Local-first AI agents on iOS and Android — real workspaces, tool execution with approvals, and your choice of model (DSH · Claude Code · Codex · GLM).
...
- [ranxianglei/billion-context](https://github.com/ranxianglei/billion-context) ⭐249 — 基本稳定可用 A context-compression plugin for small context windows (a 100K context is enough), token savings (5x fewer tokens), and month-long single sessions (billions of tokens).上下文压缩插件，兼顾小窗口(100k上下文足矣)省token(省5倍token)和超长会话(数月级别几十亿token单会话)。billion-context is all you need
...
- [fatihtoprakk/scaefy-video-production](https://github.com/fatihtoprakk/scaefy-video-production) — Code-generated video production skill pack — engine-neutral, free and offline at its core, gated by measurements instead of opinions.
- [Sur-Cai/macos-computer-use-kit](https://github.com/Sur-Cai/macos-computer-use-kit) ⭐1 — macOS computer-use toolkit for AI agents: AX-first targeting, window-scoped input, clipboard-safe paste, action read-back verification, visual overlay, Jev semantic guards
...
*Generated on 2026-09-23 · 1000 plugins in this category*
